...
(function () {
  ...
  function Wa(h, m, B) {
    "millisecond" === B ? h.setMilliseconds(h.getMilliseconds() + 1 * m) : "second" === B ? h.setSeconds(h.getSeconds() + 1 * m) : "minute" === B ? h.setMinutes(h.getMinutes() + 1 * m) : "hour" === B ? h.setHours(h.getHours() + 1 * m) : "day" === B ? h.setDate(h.getDate() + 1 * m) : "week" === B ? h.setDate(h.getDate() + 7 * m) : "month" === B ? h.setMonth(h.getMonth() + 1 * m) : "year" === B && h.setFullYear(h.getFullYear() + 1 * m);
    return h;
  }
  ...
  function Ga(h) {
    ...
    for (var m = /\s/, B = h.length; m.test(h.charAt(--B));) {
      ;
    }

    return h.slice(0, B + 1);
  }
  ...
  function Ca(h) {
    h.roundRect = function (h, B, r, w, S, A, v, E) {
      ...
      "undefined" === typeof S && (S = 5);
      this.lineWidth = A;
      this.beginPath();
      this.moveTo(h + S, B);
      this.lineTo(h + r - S, B);
      this.quadraticCurveTo(h + r, B, h + r, B + S);
      this.lineTo(h + r, B + w - S);
      this.quadraticCurveTo(h + r, B + w, h + r - S, B + w);
      this.lineTo(h + S, B + w);
      this.quadraticCurveTo(h, B + w, h, B + w - S);
      this.lineTo(h, B + S);
      this.quadraticCurveTo(h, B, h + S, B);
      this.closePath();
      v && this.fill();
      E && 0 < A && this.stroke();
    };
  ...
  function fb(h) {
    if (U.fSDec) h[ia("`eeDwdouMhrudods")](ia("e`u`@ohl`uhnoHuds`uhnoDoe"), function () {
      U._fTWm && U._fTWm(h);
    });
  }
  ...
  function J(h, m) {
    ...
    }[h || "solid"]) for (var r = 0; r < B.length; r++) {
      B[r] *= m;
    } else B = [];
    return B;
  }

  function K(h, m, B, w, ua) {
    w = w || [];
    ua = r(ua) ? gb ? {
      passive: !1,
      capture: !1
    ...
    w.push([h, m, B, ua]);
    return h.addEventListener ? (h.addEventListener(m, B, ua), B) : h.attachEvent ? (w = function w(m) {
      m = m || window.event;
  ...
  function hb(h) {
    if (h._menuButton) h.exportEnabled ? (W(h._menuButton, {
      backgroundColor: h.toolbar.itemBackgroundColor,
      color: h.toolbar.fontColor
    }), La(h._menuButton), ra(h, h._menuButton, "menu")) : va(h._menuButton);else if (h.exportEnabled && w) {
      var m = !1;
      ...
      K(h._menuButton, "mousemove", function () {
        ...
        }), 0 >= navigator.userAgent.search("MSIE") && W(h._menuButton.childNodes[0], {
    ...
    if (h.exportEnabled && h._dropdownMenu) {
      ...
      for (var B = h._dropdownMenu.childNodes, r = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], ua = 0; ua < B.length; ua++) {
        W(B[ua], {
          backgroundColor: h.toolbar.itemBackgroundColor,
          color: h.toolbar.fontColor
        }), B[ua].innerHTML = r[ua];
      }
    } else !h._dropdownMenu && h.exportEnabled && w && (m = !1, h._dropdownMenu = document.createElement("div"), h._dropdownMenu.setAttribute("tabindex", -1), B = -1 !== h.theme.indexOf("dark") ? "white" : "#888888", W(h._dropdownMenu, {
      position: "absolute",
      zIndex: 1,
      userSelect: "none",
      MozUserSeelct: "none",
    ...
    }, h.allDOMEventHandlers, !0), B = document.createElement("div"), W(B, {
      padding: "12px 8px 12px 8px"
    }), B.innerHTML = h._cultureInfo.printText, B.style.backgroundColor = h.toolbar.itemBackgroundColor, B.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(B), K(B, "touchstart", function (h) {
      m = !0;
    }, h.allDOMEventHandlers), K(B, "mousemove", function () {
      m || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover);
    }, h.allDOMEventHandlers, !0), K(B, "mouseout", function () {
      m || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor);
    }, h.allDOMEventHandlers, !0), K(B, "click", function () {
      h.print();
      va(h._dropdownMenu);
    }, h.allDOMEventHandlers, !0), B = document.createElement("div"), W(B, {
      padding: "12px 8px 12px 8px"
    }), B.innerHTML = h._cultureInfo.saveJPGText, B.style.backgroundColor = h.toolbar.itemBackgroundColor, B.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(B), K(B, "touchstart", function (h) {
      m = !0;
    }, h.allDOMEventHandlers), K(B, "mousemove", function () {
      m || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover);
    }, h.allDOMEventHandlers, !0), K(B, "mouseout", function () {
      ...
      padding: "12px 8px 12px 8px"
    }), B.innerHTML = h._cultureInfo.savePNGText, B.style.backgroundColor = h.toolbar.itemBackgroundColor, B.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(B), K(B, "touchstart", function (h) {
      m = !0;
    }, h.allDOMEventHandlers), K(B, "mousemove", function () {
      m || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover);
    }, h.allDOMEventHandlers, !0), K(B, "mouseout", function () {
  ...
  function Za(h, m, B) {
    h *= la;
    m *= la;
    h = B.getImageData(h, m, 2, 2).data;
    m = !0;

    for (B = 0; 4 > B; B++) {
      if (h[B] !== h[B + 4] | h[B] !== h[B + 8] | h[B] !== h[B + 12]) {
        m = !1;
        break;
      }
    }
  ...
  function Ma(h, m, B) {
    if (w && $a) {
      ...
      h.width = m * la;
      h.height = B * la;
      Ra !== Na && (h.style.width = m + "px", h.style.height = B + "px", r.scale(la, la));
    } else h.width = m, h.height = B;
  }
  ...
  function ib(h) {
    if (!jb) {
      var m = !1,
          B = !1;
      "undefined" === typeof qa.Chart.creditHref ? (h.creditHref = ia("iuuqr;..b`ow`rkr/bnl."), h.creditText = ia("B`ow`rKR/bnl")) : (m = h.updateOption("creditText"), B = h.updateOption("creditHref"));
      ...
      if (h.creditHref && h.creditText) {
        ...
        if (0 === h.renderCount || m || B) h._creditLink.setAttribute("href", h.creditHref), h._creditLink.innerHTML = h.creditText;
  ...
  function ra(h, m, B) {
    m.getAttribute("state") || (m.style.backgroundColor = h.toolbar.itemBackgroundColor, m.style.color = h.toolbar.fontColor, m.style.border = "none", W(m, {
      WebkitUserSelect: "none",
      MozUserSelect: "none",
      msUserSelect: "none",
      userSelect: "none"
    }));
    m.getAttribute("state") !== B && (m.setAttribute("state", B), m.setAttribute("type", "button"), W(m, {
      padding: "5px 12px",
      cursor: "pointer",
      "float": "left",
      width: "40px",
      ...
      lineHeight: "0"
    }), m.innerHTML = "<img src='" + kb[B].image + "' alt='" + h._cultureInfo[B + "Text"] + "' />", W(m.childNodes[0], {
      height: "95%",
      pointerEvents: "none"
    }));
    m.setAttribute("title", h._cultureInfo[B + "Text"]);
  }
  ...
  function Sa(h, m, B, r, w) {
    if (null === h || "undefined" === typeof h) return "undefined" === typeof B ? m : B;
    h = parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ? m / 100 : 1);
    "undefined" !== typeof r && (h = Math.min(r, h), "undefined" !== typeof w && (h = Math.max(w, h)));
    return !isNaN(h) && h <= m && 0 <= h ? h : "undefined" === typeof B ? m : B;
  }

  function V(h, m, B, w, v) {
    this._defaultsKey = h;
  ...
  function ya(h, m) {
    ...
    if (r(this.options.margin) && h.options.subtitles) for (var B = h.options.subtitles, w = 0; w < B.length; w++) {
      if ((r(B[w].horizontalAlign) && "center" === this.horizontalAlign || B[w].horizontalAlign === this.horizontalAlign) && (r(B[w].verticalAlign) && "top" === this.verticalAlign || B[w].verticalAlign === this.verticalAlign) && !B[w].dockInsidePlotArea === !this.dockInsidePlotArea) {
        this.margin = 0;
        break;
      }
    }
  ...
  (function () {
    U.fSDec = function (h) {
      for (var m = "", r = 0; r < h.length; r++) {
        m += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(r));
      }

      return m;
    };

    delete qa[U.fSDec("Bi`su")][U.fSDec("bsdehuIsdg")];
    U.pro = {
      sCH: qa[U.fSDec("Bi`su")][U.fSDec("bsdehuIsdg")]
    };
    ...
    U._fTWm = function (h) {
      if ("undefined" === typeof U.pro.sCH && !cb) try {
        var m,
            r = h[U.fSDec("buy")];
        r[U.fSDec("udyuC`rdmhod")] = U.fSDec("unq");
        r[U.fSDec("gnou")] = 11 + U.fSDec("qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg");
        m = h.height - 11;
        r[U.fSDec("bmd`sSdbu")](0, m, r[U.fSDec("ld`rtsdUdyu")](U.fSDec("B`ow`rKR!Ush`m")).width, 11);
        r[U.fSDec("ghmmRuxmd")] = h.backgroundColor;
        r[U.fSDec("ghmmSdbu")](0, m, r[U.fSDec("ld`rtsdUdyu")](U.fSDec("B`ow`rKR!Ush`m")).width, 11);
        r[U.fSDec("ghmmRuxmd")] = U.fSDec("fsdx");
        r[U.fSDec("ghmmUdyu")](U.fSDec("B`ow`rKR!Ush`m"), 0, m);
      } catch (w) {}
    };
  })();
  ...
  var gb = function () {
    ...
    return function (E, J, O) {
      ...
      "UTC:" === J.slice(0, 4) && (J = J.slice(4), U = !0);
      O = U ? "getUTC" : "get";
      var W = E[O + "Date"](),
          N = E[O + "Day"](),
          ba = E[O + "Month"](),
      ...
      return O = J.replace(h, function (l) {
        switch (l) {
          ...
          case "K":
            return U ? "UTC" : (String(E).match(S) || [""]).pop().replace(A, "");
    ...
    for (var N = 0; E && N < E.length; N++) {
      if (m = E[N], "." === m && 0 > J) J = N;else {
        if ("%" === m) A *= 100;else if ("\u2030" === m) {
          A *= 1E3;
          continue;
        ...
        0 > J ? (O.push(m), "#" === m || "0" === m ? P++ : "," === m && I++) : (R.push(m), "#" !== m && "0" !== m || K++);
      }
    }

    U && (m = Math.floor(h), E = -Math.floor(Math.log(h) / Math.LN10 + 1), W = 0 === h ? 0 : 0 === m ? -(P + E) : String(m).length - P, A /= Math.pow(10, W));
    0 > J && (J = N);
    A = (h * A).toFixed(K);
    m = A.split(".");
    A = (m[0] + "").split("");
    ...
    for (U = E = N = K = J = 0; 0 < O.length;) {
      if (m = O.pop(), "#" === m || "0" === m) {
        if (J++, J === P) {
          var ba = A,
              A = [];
          if ("0" === m) for (m = P - K - (ba ? ba.length : 0); 0 < m;) {
            ba.unshift("0"), m--;
          }

          for (; 0 < ba.length;) {
            r = ba.pop() + r, U++, 0 === U % E && N === I && 0 < ba.length && (r = S + r);
          }
        } else 0 < A.length ? (r = A.pop() + r, K++, U++) : "0" === m && (r = "0" + r, K++, U++), 0 === U % E && N === I && 0 < A.length && (r = S + r);
      } else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (N++, E = U, U = 0, 0 < A.length && (r = S + r)) : r = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + r : m + r : (m = 0 > W ? m.replace("+", "").replace("-", "") : m.replace("-", ""), r += m.replace(/[0]+/, function (a) {
        return Z(W, a.length);
      }));
    }
    ...
    for (O = !1; 0 < R.length;) {
      m = R.shift(), "#" === m || "0" === m ? 0 < h.length && 0 !== Number(h.join("")) ? (S += h.shift(), O = !0) : "0" === m && (S += "0", O = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? S += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? S += m : (m = 0 > W ? m.replace("+", "").replace("-", "") : m.replace("-", ""), S += m.replace(/[0]+/, function (a) {
        return Z(W, a.length);
      }));
    }
    ...
    return {
      ...
      Na = 1,
      la = $a ? Ra / Na : 1,
      ea = function ea(h, m, r, w, v, E, A, J, P, O, R, U, K) {
    "undefined" === typeof K && (K = 1);
    A = A || 0;
    J = J || "white";
    var I = 15 < w - m && 15 < v - r ? 8 : 0.35 * Math.min(w - m, v - r);
    h.beginPath();
    h.moveTo(m, r);
    h.save();
    h.fillStyle = E;
    ...
    h.globalAlpha = 1;
    0 < A && (K = 0 === A % 2 ? 0 : 0.5, h.beginPath(), h.lineWidth = A, h.strokeStyle = J, h.moveTo(m, r), h.rect(m - K, r - K, w - m + 2 * K, v - r + 2 * K), h.stroke());
    h.restore();
    !0 === P && (h.save(), h.beginPath(), h.moveTo(m, r), h.lineTo(m + I, r + I), h.lineTo(w - I, r + I), h.lineTo(w, r), h.closePath(), A = h.createLinearGradient((w + m) / 2, r + I, (w + m) / 2, r), A.addColorStop(0, E), A.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = A, h.fill(), h.restore());
    !0 === O && (h.save(), h.beginPath(), h.moveTo(m, v), h.lineTo(m + I, v - I), h.lineTo(w - I, v - I), h.lineTo(w, v), h.closePath(), A = h.createLinearGradient((w + m) / 2, v - I, (w + m) / 2, v), A.addColorStop(0, E), A.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = A, h.fill(), h.restore());
    !0 === R && (h.save(), h.beginPath(), h.moveTo(m, r), h.lineTo(m + I, r + I), h.lineTo(m + I, v - I), h.lineTo(m, v), h.closePath(), A = h.createLinearGradient(m + I, (v + r) / 2, m, (v + r) / 2), A.addColorStop(0, E), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = A, h.fill(), h.restore());
    !0 === U && (h.save(), h.beginPath(), h.moveTo(w, r), h.lineTo(w - I, r + I), h.lineTo(w - I, v - I), h.lineTo(w, v), A = h.createLinearGradient(w - I, (v + r) / 2, w, (v + r) / 2), A.addColorStop(0, E), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = A, A.addColorStop(0, E), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = A, h.fill(), h.closePath(), h.restore());
  },
      ia = function ia(h) {
    for (var m = "", r = 0; r < h.length; r++) {
      m += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(r));
    ...
    return m;
      ...
      cb = window && window[ia("mnb`uhno")] && window[ia("mnb`uhno")].href && window[ia("mnb`uhno")].href.indexOf && (-1 !== window[ia("mnb`uhno")].href.indexOf(ia("b`ow`rkr/bnl")) || -1 !== window[ia("mnb`uhno")].href.indexOf(ia("gdonqhy/bnl")) || -1 !== window[ia("mnb`uhno")].href.indexOf(ia("gheemd"))),
  ...
  V.prototype.setOptions = function (h, m) {
    if (qa[this._defaultsKey]) {
      ...
      for (w in r) {
        "publicProperties" !== w && r.hasOwnProperty(w) && (this[w] = h && w in h ? h[w] : m && w in m ? m[w] : r[w]);
      }
  ...
  V.prototype.set = function (h, m, r) {
    ...
    if ("options" === h) this.createUserOptions(m);else if (w.hasOwnProperty(h) || w.publicProperties && w.publicProperties.hasOwnProperty(h) && "readWrite" === w.publicProperties[h]) this.options._isPlaceholder && this.createUserOptions(), this.options[h] = m;else {
  ...
  V.prototype.updateOption = function (h) {
    ...
    var m = qa[this._defaultsKey],
        ...
        S = this._index;
    this.theme && r(this.parent) && r(E) && r(S) ? w = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && this.parent.themeOptions && this.parent.themeOptions[E] && (null === S ? w = this.parent.themeOptions[E] : 0 < this.parent.themeOptions[E].length && (w = Math.min(this.parent.themeOptions[E].length - 1, S), w = this.parent.themeOptions[E][w]));
    this.themeOptions = w;
  ...
  V.prototype.addEventListener = function (h, m, r) {
  ...
  V.prototype.removeEventListener = function (h, m) {
    if (h && m && this._eventListeners[h]) for (var r = this._eventListeners[h], w = 0; w < r.length; w++) {
  ...
  V.prototype.dispatchEvent = function (h, m, r) {
  ...
  ja.prototype._initialize = function () {
    r(this.padding) || "object" !== _typeof(this.padding) ? this.topPadding = this.rightPadding = this.bottomPadding = this.leftPadding = Number(this.padding) | 0 : (this.topPadding = r(this.padding.top) ? 0 : Number(this.padding.top) | 0, this.rightPadding = r(this.padding.right) ? 0 : Number(this.padding.right) | 0, this.bottomPadding = r(this.padding.bottom) ? 0 : Number(this.padding.bottom) | 0, this.leftPadding = r(this.padding.left) ? 0 : Number(this.padding.left) | 0);
  };
  ...
  ja.prototype._getLineWithWidth = function (h, m, r) {
    h = String(h);
    if (!h) return {
      text: "",
      width: 0
  ...
  ja.prototype._wrapText = function () {
    var h = new String(Ga(String(this.text))),
        ...
        v = 0;
    this.ctx.font = this._getFontString();
    if (0 === this.frontSize) v = w = 0;else for (; 0 < h.length;) {
  ...
  ya.prototype.setLayout = function () {
    if (this.text) {
      var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
          ...
          I,
          K;
      "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = m.width - 4 - A * ("center" === this.horizontalAlign ? 2 : 1)), J = 0.5 * m.height - this.margin - 2, E = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = m.height - 4), J = 0.5 * m.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = m.width - 4), J = 0.5 * m.height - 4));
      var O;
      r(this.padding) || "number" !== typeof this.padding ? r(this.padding) || "object" !== _typeof(this.padding) || (O = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0, O += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0) : O = 2 * this.padding;
  ...
  Ua.prototype.get = function (h, m) {
    var r = null;
    0 < this.pool.length ? (r = this.pool.pop(), Ma(r, h, m)) : r = ta(h, m);
    return r;
  };
  ...
  var Pa = {
    ...
    formatNumber: function formatNumber(h, m, r) {
      r = r || "en";
      if (Ka[r]) return da(h, m || "#,##0.##", new Ja(r));
      throw "Unknown Culture Name";
    },
    formatDate: function formatDate(h, m, r) {
      r = r || "en";
  ...
  v = Pa.Chart = function () {
    ...
    function m(a, d, c) {
      d = d || {};
      r(c) ? (this.predefinedThemes = bb, this.optionsName = this.parent = this.index = null) : (this.parent = c.parent, this.index = c.index, this.predefinedThemes = c.predefinedThemes, this.optionsName = c.optionsName, this.stockChart = c.stockChart, this.panel = a, this.isOptionsInArray = c.isOptionsInArray);
    ...
    function v(a, d) {
      for (var c = [], b, e = 0; e < a.length; e++) {
        if (0 == e) c.push(a[0]);else {
          ...
          var D = (a[l].x - a[f].x) / b;
          b = (a[l].y - a[f].y) / b;
          c[c.length] = a[s].x > a[f].x && 0 < D || a[s].x < a[f].x && 0 > D ? {
            x: a[s].x + D / 3,
            y: a[s].y + b / 3
          } : {
            x: a[s].x,
    ...
    function E(a, d, c, b, e, f, l, s, D, k) {
      ...
      a.beginPath();
      D && 0 < s.thickness ? (a.moveTo(b - l.thickness / 2, Math.round((c + e) / 2) - p), a.lineTo(d + l.thickness / 2, Math.round((c + e) / 2) - p)) : 0 < s.thickness && (a.moveTo(Math.round((d + b) / 2) - p, c + l.thickness / 2), a.lineTo(Math.round((d + b) / 2) - p, e - l.thickness / 2));
      a.stroke();
    ...
    function R(a, d) {
      R.base.constructor.call(this, "Legend", "legend", d, null, a);
      this.chart = a;
    ...
    function S(a, d, c, b) {
      S.base.constructor.call(this, "DataSeries", "data", d, c, a);
      this.chart = a;
      this.canvas = a.canvas;
    ...
    function A(a, d, c, b, e, f) {
      ...
      this.options.scaleBreaks && (this.scaleBreaks = new X(this.chart, this.options.scaleBreaks, ++this.chart._eventManager.lastObjectId, this));
      this.stripLines = [];
    ...
    function X(a, d, c, b) {
      X.base.constructor.call(this, "ScaleBreaks", "scaleBreaks", d, null, b);
      this.id = c;
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.axis = b;
    ...
    function $(a, d, c, b, e, f) {
      $.base.constructor.call(this, "Break", d, c, b, f);
      this.id = e;
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.scaleBreaks = f;
    ...
    m.prototype._updateOptions = function () {
      ...
      if (this.options.zoomEnabled || this.panEnabled) {
        if (this._zoomButton) W(this._zoomButton, {
        ...
        }), ra(this, this._zoomButton, "zoom");else {
          var d = !1;
          ...
          K(this._zoomButton, "mousemove", function () {
            ...
            }), 0 >= navigator.userAgent.search("MSIE") && W(a._zoomButton.childNodes[0], {
              WebkitFilter: "invert(100%)",
              filter: "invert(100%)"
            }));
          }, this.allDOMEventHandlers);
        ...
        this._resetButton ? (W(this._resetButton, {
          borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor,
          backgroundColor: a.toolbar.itemBackgroundColor,
          color: a.toolbar.fontColor
          ...
          0 >= navigator.userAgent.search("MSIE") && W(a._resetButton.childNodes[0], {
            WebkitFilter: "invert(0%)",
            filter: "invert(0%)"
          });
    ...
    m.prototype._initialize = function () {
      ...
      this._animator ? this._animator.cancelAllAnimations() : this._animator = new Y(this);
      ...
      if (this.options.data) {
        for (var c = 0; c < this.options.data.length; c++) {
          if (a++, !this.options.data[c].type || 0 <= m._supportedChartTypes.indexOf(this.options.data[c].type)) {
            var b = new S(this, this.options.data[c], a - 1, ++this._eventManager.lastObjectId);
        ...
        if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) {
          ...
          if ("secondary" === this.data[d].axisYType) if (this.options.axisY2 && 0 < this.options.axisY2.length) {
            if (!this.axisY2.length) for (c = 0; c < this.options.axisY2.length; c++) {
              "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[c] = new A(this, "axisY2", this.options.axisY2[c], c, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[c] = new A(this, "axisY2", this.options.axisY2[c], c, "axisY", "top"));
            }
    ...
    m.prototype.renderElements = function () {
      ...
      if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) A.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement);else if ("none" === this.plotInfo.axisPlacement) this.preparePlotArea();else return;
      ...
      if (0 < c.length) n.disableToolTip = !0, n._animator.animate(200, n.animationDuration, function (a) {
        ...
        for (var e = 0; e < c.length; e++) {
          D = c[e], 1 > a && "undefined" !== typeof D.startTimePercent ? a >= D.startTimePercent && D.animationCallback(D.easingFunction(a - D.startTimePercent, 0, 1, 1 - D.startTimePercent), D) : D.animationCallback(D.easingFunction(a, 0, 1, 1), D);
        }
        ...
        if (n._breaksCanvas) if (w) n.plotArea.ctx.drawImage(n._breaksCanvas, 0, 0, this.width, this.height);else for (k = 0; k < n._axes.length; k++) {
    ...
    m.prototype._processMultiseriesPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
        ...
        if (s.dataPoints[D].x && s.dataPoints[D].x.getTime || "dateTime" === s.xValueType) f = !0;

        for (D = 0; D < s.dataPoints.length; D++) {
          "undefined" === typeof s.dataPoints[D].x && (s.dataPoints[D].x = D + (a.axisX.logarithmic ? 1 : 0));
          s.dataPoints[D].x.getTime ? (f = !0, b = s.dataPoints[D].x.getTime()) : b = s.dataPoints[D].x;
          e = s.dataPoints[D].y;
          b < c.min && (c.min = b);
          b > c.max && (c.max = b);
          ...
          if (0 < D) {
            ...
            } else t = b - s.dataPoints[D - 1].x, 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t);

            null !== e && null !== s.dataPoints[D - 1].y && (a.axisY.logarithmic ? (t = e / s.dataPoints[D - 1].y, 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e - s.dataPoints[D - 1].y, 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t)));
          }
          ...
          if (b < q && !k) null !== e && (p = b);else {
            ...
            s.dataPoints[D].label && (a.axisX.labels[b] = s.dataPoints[D].label);
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], s = [], D = Infinity, k = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          for (q = 0; q < p.dataPoints.length; q++) {
            ...
            if (b < fa && !g) null !== p.dataPoints[q].y && (h = b);else {
              if (!g && (g = !0, 0 < q)) {
                q -= 2;
                continue;
              }

              if (b > u && !t) t = !0;else if (b > u && t) continue;
              p.dataPoints[q].label && (a.axisX.labels[b] = p.dataPoints[q].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === p.dataPoints[q].y ? c.viewPortMin === b && h < b && (c.viewPortMin = h) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l[b] ? l[b] += e : (l[b] = e, D = Math.min(e, D)) : s[b] ? s[b] += e : (s[b] = e, k = Math.max(e, k)));
            }
          }
        ...
        for (q in l) {
          l.hasOwnProperty(q) && !isNaN(q) && (a = l[q], a < d.min && (d.min = Math.min(a, D)), a > d.max && (d.max = a), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, D)), a > d.viewPortMax && (d.viewPortMax = a)));
        }

        for (q in s) {
          s.hasOwnProperty(q) && !isNaN(q) && (a = s[q], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, k)), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, k))));
        }
      }
    };
        ...
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, s = !1, D = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
          ...
          for (p = 0; p < n.dataPoints.length; p++) {
            ...
            if (b < h && !q) null !== e && (t = b);else {
              ...
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === e ? c.viewPortMin === b && t < b && (c.viewPortMin = t) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l = !0 : 0 > e && (s = !0), D[b] = D[b] ? D[b] + Math.abs(e) : Math.abs(e));
            }
          }
    ...
    m.prototype._processMultiYPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, s = !1, D = 0; D < a.dataSeriesIndexes.length; D++) {
        ...
        for (n = 0; n < k.dataPoints.length; n++) {
          ...
          k.dataPoints[n].x.getTime ? (s = !0, b = k.dataPoints[n].x.getTime()) : b = k.dataPoints[n].x;
          ...
          f < d.min && (d.min = f);
          l > d.max && (d.max = l);
          0 < n && (a.axisX.logarithmic ? (t = b / k.dataPoints[n - 1].x, 1 > t && (t = 1 / t), c.minDiff > t && 1 !== t && (c.minDiff = t)) : (t = b - k.dataPoints[n - 1].x, 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t)), e && null !== e[0] && k.dataPoints[n - 1].y && null !== k.dataPoints[n - 1].y[0] && (a.axisY.logarithmic ? (t = e[0] / k.dataPoints[n - 1].y[0], 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e[0] - k.dataPoints[n - 1].y[0], 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t))));
          ...
          if (!(b < m) || p) {
            ...
            if (b > u && !q) q = !0;else if (b > u && q) continue;
            k.dataPoints[n].label && (a.axisX.labels[b] = k.dataPoints[n].label);
            b < c.viewPortMin && (c.viewPortMin = b);
            b > c.viewPortMax && (c.viewPortMax = b);
            if (c.viewPortMin === b && e) for (r = 0; r < e.length; r++) {
              if (null === e[r] && g < b) {
                c.viewPortMin = g;
                break;
              }
    ...
    m.prototype._processSpecificPlotUnit = function (a) {
      if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
        ...
        for (D = 0; D < s.dataPoints.length; D++) {
          "undefined" !== typeof s.dataPoints[D].isCumulativeSum && !0 === s.dataPoints[D].isCumulativeSum ? (s.dataPointEOs[D].cumulativeSumYStartValue = 0, s.dataPointEOs[D].cumulativeSum = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum, s.dataPoints[D].y = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum) : "undefined" !== typeof s.dataPoints[D].isIntermediateSum && !0 === s.dataPoints[D].isIntermediateSum ? (s.dataPointEOs[D].cumulativeSumYStartValue = p, s.dataPointEOs[D].cumulativeSum = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum, s.dataPoints[D].y = 0 === D ? 0 : b, p = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum, b = 0) : (e = "number" !== typeof s.dataPoints[D].y ? 0 : s.dataPoints[D].y, s.dataPointEOs[D].cumulativeSumYStartValue = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum, s.dataPointEOs[D].cumulativeSum = 0 === D ? e : s.dataPointEOs[D - 1].cumulativeSum + e, b += e);
        }

        for (D = 0; D < s.dataPoints.length; D++) {
          if ("undefined" === typeof s.dataPoints[D].x && (s.dataPoints[D].x = D + (a.axisX.logarithmic ? 1 : 0)), s.dataPoints[D].x.getTime ? (f = !0, b = s.dataPoints[D].x.getTime()) : b = s.dataPoints[D].x, e = s.dataPoints[D].y, b < c.min && (c.min = b), b > c.max && (c.max = b), s.dataPointEOs[D].cumulativeSum < d.min && (d.min = s.dataPointEOs[D].cumulativeSum), s.dataPointEOs[D].cumulativeSum > d.max && (d.max = s.dataPointEOs[D].cumulativeSum), 0 < D && (a.axisX.logarithmic ? (p = b / s.dataPoints[D - 1].x, 1 > p && (p = 1 / p), c.minDiff > p && 1 !== p && (c.minDiff = p)) : (p = b - s.dataPoints[D - 1].x, 0 > p && (p *= -1), c.minDiff > p && 0 !== p && (c.minDiff = p)), null !== e && null !== s.dataPoints[D - 1].y && (a.axisY.logarithmic ? (e = s.dataPointEOs[D].cumulativeSum / s.dataPointEOs[D - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = s.dataPointEOs[D].cumulativeSum - s.dataPointEOs[D - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < q) || k) {
            if (!k && (k = !0, 0 < D)) {
              D -= 2;
              continue;
            }
            ...
            b < c.viewPortMin && (c.viewPortMin = b);
            b > c.viewPortMax && (c.viewPortMax = b);
            0 < D && (s.dataPointEOs[D - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = s.dataPointEOs[D - 1].cumulativeSum), s.dataPointEOs[D - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = s.dataPointEOs[D - 1].cumulativeSum));
            s.dataPointEOs[D].cumulativeSum < d.viewPortMin && (d.viewPortMin = s.dataPointEOs[D].cumulativeSum);
            s.dataPointEOs[D].cumulativeSum > d.viewPortMax && (d.viewPortMax = s.dataPointEOs[D].cumulativeSum);
          }
        }
    ...
    m.prototype.calculateAutoBreaks = function () {
      ...
      function d(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, l = f.min, k = f.max, n = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, s = 0, D = 0; D < a.dataSeriesIndexes.length; D++) {
            var h = e.data[a.dataSeriesIndexes[D]];
            if (!(4 > h.dataPoints.length)) for (s = 0; s < h.dataPoints.length; s++) {
              if (b && (q = (k + 1 - l) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = h.dataPoints[s].x.getTime ? h.dataPoints[s].x.getTime() : h.dataPoints[s].x, q = Math.floor((g - l) / q), g < f[q].min && (f[q].min = g), g > f[q].max && (f[q].max = g)), c) {
                var m = (p + 1 - n) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
                if ((g = "waterfall" === a.type ? h.dataPointEOs[s].cumulativeSum : h.dataPoints[s].y) && g.length) for (var w = 0; w < g.length; w++) {
                  q = Math.floor((g[w] - n) / m), g[w] < d[q].min && (d[q].min = g[w]), g[w] > d[q].max && (d[q].max = g[w]);
      ...
      function c(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks) for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, l = 0, k = 0; k < a.dataSeriesIndexes.length; k++) {
          var n = e.data[a.dataSeriesIndexes[k]];
          if (!(4 > n.dataPoints.length)) for (l = 0; l < n.dataPoints.length; l++) {
            g = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = n.dataPoints[l].x.getTime ? n.dataPoints[l].x.getTime() : n.dataPoints[l].x, g = Math.floor((b - c) / g), b < f[g].min && (f[g].min = b), b > f[g].max && (f[g].max = b);
          }
        }
      }
      ...
      for (var b, e = this, f = !1, l = 0; l < this._axes.length; l++) {
        if (this._axes[l].scaleBreaks && this._axes[l].scaleBreaks.autoCalculate && 1 <= this._axes[l].scaleBreaks.maxNumberOfAutoBreaks) {
          ...
          for (var s = 0; s < 100 / Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) || 10, 10); s++) {
        ...
        for (l = 0; l < this._axes.length; l++) {
          if (this._axes[l].dataInfo._dataRanges) {
            ...
            if (this._axes[l].dataInfo.dataPointYNegativeSums) {
              ...
              for (s in q) {
                q.hasOwnProperty(s) && !isNaN(s) && (p = -1 * q[s], r(p) || (g = Math.floor((p - D) / b), p < n[g].min && (n[g].min = p), p > n[g].max && (n[g].max = p)));
              }
            ...
            for (s = 0; s < k.length - 1; s++) {
              if (n = k[s].max, isFinite(n)) for (; s < k.length - 1;) {
    ...
    m.prototype.getDataPointAtXY = function (a, d, c) {
      ...
      for (c = 0; c < b.length; c++) {
        if ("line" === b[c].dataSeries.type || "stepLine" === b[c].dataSeries.type || "area" === b[c].dataSeries.type || "stepArea" === b[c].dataSeries.type) if (e = ma("markerSize", b[c].dataPoint, b[c].dataSeries) || 8, b[c].distance <= e / 2) {
          d = !0;
          break;
        }
      }
    ...
    m.prototype.getObjectAtXY = function (a, d, c) {
      var b = null;
      if (c = this.getDataPointAtXY(a, d, c || !1)) b = c.dataSeries.dataPointIds[c.dataPointIndex];else if (w) b = Za(a, d, this._eventManager.ghostCtx);else for (c = 0; c < this.legend.items.length; c++) {
    ...
    m.prototype._dispatchRangeEvent = function (a, d) {
      ...
      for (var e = 0; e < b.length; e++) {
        if (r(c[b[e]]) && (c[b[e]] = []), "axisY" === b[e]) for (var f = 0; f < this.axisY.length; f++) {
          c[b[e]].push({
      ...
      if (this.interactivityEnabled) if (this._ignoreNextEvent) this._ignoreNextEvent = !1;else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Ha && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which), "mouseup" === c && window.console.log("mouseup")), !e) {
        ...
        if (d.x < c.x1 || d.x > c.x2 || d.y < c.y1 || d.y > c.y2) {
          ...
          for (f = 0; f < this.axisX.length; f++) {
            this.axisX[f].crosshair && this.axisX[f].crosshair.enabled && (this.axisX[f].crosshair.hide(), this.axisX[f].crosshair.dispatchEvent("hidden", {
              chart: this,
          ...
          for (f = 0; f < this.axisX2.length; f++) {
            this.axisX2[f].crosshair && this.axisX2[f].crosshair.enabled && (this.axisX2[f].crosshair.hide(), this.axisX2[f].crosshair.dispatchEvent("hidden", {
              chart: this,
          ...
          for (f = 0; f < this.axisY.length; f++) {
            this.axisY[f].crosshair && this.axisY[f].crosshair.enabled && (this.axisY[f].crosshair.hide(), this.axisY[f].crosshair.dispatchEvent("hidden", {
              chart: this,
          ...
          for (f = 0; f < this.axisY2.length; f++) {
            this.axisY2[f].crosshair && this.axisY2[f].crosshair.enabled && (this.axisY2[f].crosshair.hide(), this.axisY2[f].crosshair.dispatchEvent("hidden", {
              chart: this,
    ...
    m.prototype._plotAreaMouseUp = function (a, d) {
      if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
        ...
        if (this.panEnabled || this.zoomEnabled) {
          ...
          }), this.stockChart._rangeEventParameter.type = "rangeChanging", this.stockChart.dispatchEvent("rangeChanging", this.stockChart._rangeEventParameter, this.stockChart)), this.render(), this._dispatchRangeEvent("rangeChanged", "zoom"), this.stockChart && this.stockChart.navigator && this.stockChart.navigator.enabled && (this.stockChart._rangeEventParameter.type = "rangeChanged", this.stockChart.dispatchEvent("rangeChanged", this.stockChart._rangeEventParameter, this.stockChart)), l && this.zoomEnabled && "none" === this._zoomButton.style.display && (La(this._zoomButton, this._resetButton), ra(this, this._zoomButton, "pan"), ra(this, this._resetButton, "reset")));
        }
      }
      ...
      if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
        ...
        if (2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled)) {
          ...
          for (var s = 0; s < this.axisX.length; s++) {
            this.axisX[s].crosshair && this.axisX[s].crosshair.enabled && (this.axisX[s].crosshair.hide(), this.axisX[s].crosshair.dispatchEvent("hidden", {
              chart: this,
          ...
          for (s = 0; s < this.axisX2.length; s++) {
            this.axisX2[s].crosshair && this.axisX2[s].crosshair.enabled && (this.axisX2[s].crosshair.hide(), this.axisX2[s].crosshair.dispatchEvent("hidden", {
              chart: this,
          ...
          for (s = 0; s < this.axisY.length; s++) {
            this.axisY[s].crosshair && this.axisY[s].crosshair.enabled && (this.axisY[s].crosshair.hide(), this.axisY[s].crosshair.dispatchEvent("hidden", {
              chart: this,
          ...
          for (s = 0; s < this.axisY2.length; s++) {
            this.axisY2[s].crosshair && this.axisY2[s].crosshair.enabled && (this.axisY2[s].crosshair.hide(), this.axisY2[s].crosshair.dispatchEvent("hidden", {
              chart: this,
    ...
    m.prototype.validateRegion = function (a, d, c, b, e) {
      ...
      for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), s = !1, D = [], k = [], n = [], p = 0; p < this._axes.length; p++) {
      ...
      for (l = 0; l < k.length; l++) {
        ...
        if (q > g) var t = g,
            g = q,
            q = t;
        if (p.scaleBreaks) for (t = 0; !f && t < p.scaleBreaks._appliedBreaks.length; t++) {
          f = p.scaleBreaks._appliedBreaks[t].startValue <= q && p.scaleBreaks._appliedBreaks[t].endValue >= g;
        }
        if (isFinite(p.dataInfo.minDiff)) if (t = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) && (p.logarithmic && t < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && t < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) D.push(p), n.push({
          val1: q,
          val2: g
        }), s = !0;else if (!e) {
          s = !1;
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var n = this._indexLabels[a],
            ...
            D = ma("indexLabelFontStyle", n.dataPoint, n.dataSeries),
        ...
        var m = ma("indexLabelLineDashType", n.dataPoint, n.dataSeries),
            u = ma("indexLabelLineColor", n.dataPoint, n.dataSeries),
            y = r(n.dataPoint.indexLabelLineThickness) ? r(n.dataSeries.options.indexLabelLineThickness) ? 0 : n.dataSeries.options.indexLabelLineThickness : n.dataPoint.indexLabelLineThickness,
          ...
          total: null
            ...
            z = null;
        if (0 <= n.dataSeries.type.indexOf("stacked") || "pie" === n.dataSeries.type || "doughnut" === n.dataSeries.type) x = this.getPercentAndTotal(n.dataSeries, n.dataPoint);
        ...
        var G = n.dataPoint.indexLabelFormatter ? n.dataPoint.indexLabelFormatter(z) : n.dataPoint.indexLabel ? this.replaceKeywordsWithValue(n.dataPoint.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : n.dataSeries.indexLabelFormatter ? n.dataSeries.indexLabelFormatter(z) : n.dataSeries.indexLabel ? this.replaceKeywordsWithValue(n.dataSeries.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : null;

        if (null !== G && "" !== G) {
          var x = ma("indexLabelPlacement", n.dataPoint, n.dataSeries),
              z = ma("indexLabelOrientation", n.dataPoint, n.dataSeries),
              C = ma("indexLabelTextAlign", n.dataPoint, n.dataSeries),
              v = n.direction,
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            if (0 <= p.indexOf("line") || 0 <= p.indexOf("area")) x = "auto", s = 4;else if (0 <= p.indexOf("stacked")) "auto" === x && (x = "inside");else if ("bubble" === p || "scatter" === p) x = "inside";
            q = n.point.x - ("horizontal" === z ? D / 2 : D / 2 - t / 2);
            "inside" !== x ? (e = c.y1, f = c.y2, 0 < v ? (g = n.point.y + ("horizontal" === z ? t / 2 : 0) - k - s - b, g < e && (g = "auto" === x ? Math.max(n.point.y, e) + t / 2 + s : e + t / 2 + s, A = g + k > n.point.y)) : (g = n.point.y + t / 2 + s + b, g > f - k && (g = "auto" === x ? Math.min(n.point.y, f) + t / 2 - k - s : f + t / 2 - k, A = g < n.point.y))) : (e = Math.max(n.bounds.y1, c.y1), f = Math.min(n.bounds.y2, c.y2 - k + t / 2), b = 0 <= p.indexOf("range") || "error" === p ? 0 < v ? Math.max(n.bounds.y1, c.y1) + t / 2 + s : Math.min(n.bounds.y2, c.y2) + t / 2 - k + s : (Math.max(n.bounds.y1, c.y1) + Math.min(n.bounds.y2, c.y2)) / 2 - k / 2 + t / 2 + ("horizontal" === z ? s : 0), 0 < v ? (g = Math.max(n.point.y, b), g < e && ("bubble" === p || "scatter" === p) && (g = Math.max(n.point.y - k - s, c.y1 + s))) : (g = Math.min(n.point.y, b), g > f - k - s && ("bubble" === p || "scatter" === p) && (g = Math.min(n.point.y + s, c.y2 - k - s))), g = Math.min(g, f));
          } else 0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? (x = "auto", l = 4) : 0 <= p.indexOf("stacked") ? "auto" === x && (x = "inside") : "bubble" === p && (x = "inside"), g = n.point.y + t / 2 - k / 2 + s, "inside" !== x ? (e = c.x1, f = c.x2, 0 > v ? (q = n.point.x - ("horizontal" === z ? D : D - t / 2) - l - b, q < e && (q = "auto" === x ? Math.max(n.point.x, e) + l : e + l, A = q + D > n.point.x)) : (q = n.point.x + ("horizontal" === z ? 0 : t / 2) + l + b, q > f - D - l - b && (q = "auto" === x ? Math.min(n.point.x, f) - ("horizontal" === z ? D : D / 2) - l : f - D - l, A = q < n.point.x))) : (e = Math.max(n.bounds.x1, c.x1), Math.min(n.bounds.x2, c.x2), b = 0 <= p.indexOf("range") || "error" === p ? 0 > v ? Math.max(n.bounds.x1, c.x1) + t / 2 + l : Math.min(n.bounds.x2, c.x2) - D / 2 - l + ("horizontal" === z ? 0 : t / 2) : (Math.max(n.bounds.x1, c.x1) + Math.min(n.bounds.x2, c.x2)) / 2 + ("horizontal" === z ? 0 : t / 2), q = 0 > v ? Math.max(n.point.x, b) - ("horizontal" === z ? D / 2 : 0) : Math.min(n.point.x, b) - D / 2, q = Math.max(q, e));

          "vertical" === z && (g += k - t / 2);
          h.x = q;
          h.y = g;
          h.render(!0);
          y && "inside" !== x && (0 > p.indexOf("bar") && ("error" !== p || !n.axisSwapped) && n.point.x > c.x1 && n.point.x < c.x2 || !A) && (0 > p.indexOf("column") && ("error" !== p || n.axisSwapped) && n.point.y > c.y1 && n.point.y < c.y2 || !A) && (d.lineWidth = y, d.strokeStyle = u ? u : "gray", d.setLineDash && d.setLineDash(J(m, y)), d.beginPath(), d.moveTo(n.point.x, n.point.y), 0 <= p.indexOf("bar") || "error" === p && n.axisSwapped ? d.lineTo(q + (0 < n.direction ? -l : D + l) + ("vertical" === z ? -t / 2 : 0), g + ("vertical" === z ? -k / 2 : k / 2 - t / 2) - s) : 0 <= p.indexOf("column") || "error" === p && !n.axisSwapped ? d.lineTo(q + D / 2 - ("horizontal" === z ? 0 : t / 2), g + ("vertical" === z ? (g - k < n.point.y ? 0 : -k) + s : (g - t / 2 < n.point.y ? k : 0) - t / 2)) : d.lineTo(q + D / 2 - ("horizontal" === z ? 0 : t / 2), g + ("vertical" === z ? g - k < n.point.y ? 0 : -k : (g - t / 2 < n.point.y ? k : 0) - t / 2)), d.stroke());
        }
      }
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        n = this._indexLabels[a], h = ma("indexLabelBackgroundColor", n.dataPoint, n.dataSeries), n.dataSeries.indexLabelBackgroundColor = r(h) ? w ? "transparent" : null : h;
      }
        ...
        for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < n.length) {
            for (var z = !1, u = 0; u < n.length; u++) {
              if (r = n[u].x.getTime ? n[u].x.getTime() : n[u].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z))) if ("number" !== typeof n[u].y) 0 < u && !(k.connectNullData || z || m) && (c.stroke(), w && b.stroke()), z = !0;else {
                ...
                m || z ? (!m && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(r, x), w && b.lineTo(r, x)) : (c.beginPath(), c.moveTo(r, x), w && (b.beginPath(), b.moveTo(r, x))), z = m = !1) : (c.lineTo(r, x), w && b.lineTo(r, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(r, x), w && (b.stroke(), b.beginPath(), b.moveTo(r, x))));
                l = {
                  x: r,
                  y: x
                };
                u < n.length - 1 && (h !== (n[u].lineColor || t) || p !== (n[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(r, x), h = n[u].lineColor || t, c.strokeStyle = h, c.setLineDash && (n[u].lineDashType ? (p = n[u].lineDashType, c.setLineDash(J(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));

                if (0 < n[u].markerSize || 0 < k.markerSize) {
                  var C = k.getMarkerProperties(u, r, x, c);
                  f.push(C);
                  G = P(G);
                  w && f.push({
                    x: r,
    ...
    m.prototype.renderStepLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < n.length) {
            for (var z = !1, u = 0; u < n.length; u++) {
              if (r = n[u].getTime ? n[u].x.getTime() : n[u].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z))) if ("number" !== typeof n[u].y) 0 < u && !(k.connectNullData || z || m) && (c.stroke(), w && b.stroke()), z = !0;else {
                var G = x;
                r = a.axisX.convertValueToPixel(r);
                x = a.axisY.convertValueToPixel(n[u].y);
                ...
                m || z ? (!m && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(r, G), c.lineTo(r, x), w && (b.lineTo(r, G), b.lineTo(r, x))) : (c.beginPath(), c.moveTo(r, x), w && (b.beginPath(), b.moveTo(r, x))), z = m = !1) : (c.lineTo(r, G), w && b.lineTo(r, G), c.lineTo(r, x), w && b.lineTo(r, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(r, x), w && (b.stroke(), b.beginPath(), b.moveTo(r, x))));
                l = {
                  x: r,
                  y: x
                };
                u < n.length - 1 && (h !== (n[u].lineColor || t) || p !== (n[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(r, x), h = n[u].lineColor || t, c.strokeStyle = h, c.setLineDash && (n[u].lineDashType ? (p = n[u].lineDashType, c.setLineDash(J(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
                if (0 < n[u].markerSize || 0 < k.markerSize) G = k.getMarkerProperties(u, r, x, c), f.push(G), C = P(C), w && f.push({
                  x: r,
                  y: x,
                  ctx: b,
                  type: G.type,
      ...
      function d(a) {
        ...
        if (0 < a.length) {
          ...
          for (var c = 0; c < a.length - 3; c += 3) {
            if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), w && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), 0 < c && 0 === c % 3E3 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(a[c + 3].x, a[c + 3].y), a[c + 3].newStrokeStyle && (b.strokeStyle = a[c + 3].newStrokeStyle), a[c + 3].newLineDashArray && b.setLineDash(a[c + 3].newLineDashArray), w && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y));
          }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = [], s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          var r = 0,
              ...
              x = [];
          b.beginPath();
          if (0 < n.length) for (m = !1, r = 0; r < n.length; r++) {
            if (u = n[r].getTime ? n[r].x.getTime() : n[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !m))) if ("number" !== typeof n[r].y) 0 < r && !m && (k.connectNullData ? b.setLineDash && 0 < x.length && (k.options.nullDataLineDashType || !n[r - 1].lineDashType) && (x[x.length - 1].newLineDashArray = q, p = k.nullDataLineDashType) : (d(x), x = [])), m = !0;else {
              ...
              r < n.length - 1 && (h !== (n[r].lineColor || t) || p !== (n[r].lineDashType || k.lineDashType)) && (h = n[r].lineColor || t, x[x.length - 1].newStrokeStyle = h, b.setLineDash && (n[r].lineDashType ? (p = n[r].lineDashType, x[x.length - 1].newLineDashArray = J(p, k.lineThickness)) : (p = k.lineDashType, x[x.length - 1].newLineDashArray = g)));

              if (0 < n[r].markerSize || 0 < k.markerSize) {
                var G = k.getMarkerProperties(r, u, m, b);
                l.push(G);
                z = P(z);
                w && l.push({
                  x: u,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (n = 0; n < a.dataSeriesIndexes.length; n++) {
          var q = a.dataSeriesIndexes[n],
              g = this.data[q],
              t = g.dataPoints;
          if (0 < t.length) for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < t.length; f++) {
            if (t[f].getTime ? D = t[f].x.getTime() : D = t[f].x, !(D < a.axisX.dataInfo.viewPortMin || D > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[f].y) {
              ...
              ea(c, a.axisX.reversed ? r : l, s, a.axisX.reversed ? l : r, u, b, 0, null, h && (a.axisY.reversed ? 0 > t[f].y : 0 <= t[f].y), (a.axisY.reversed ? 0 <= t[f].y : 0 > t[f].y) && h, !1, !1, g.fillOpacity);
              b = g.dataPointIds[f];
              ...
              b = P(b);
              w && ea(this._eventManager.ghostCtx, a.axisX.reversed ? r : l, s, a.axisX.reversed ? l : r, u, b, 0, null, !1, !1, !1, !1);
    ...
    m.prototype.renderStackedColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        t = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(t) / Math.log(a.axisX.range) : Math.abs(t) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++) {
              if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                ...
                n = n - a.plotType.plotUnits.length * t / 2 + a.index * t << 0;
                var x = n + t << 0,
                    z;
                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) s[b] = u[k].y + (s[b] ? s[b] : 0), 0 < s[b] && (p = a.axisY.convertValueToPixel(s[b]), z = "undefined" !== typeof f[b] ? f[b] : q, f[b] = p);else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) D[b] = u[k].y + (D[b] ? D[b] : 0), z = a.axisY.convertValueToPixel(D[b]), p = "undefined" !== typeof l[b] ? l[b] : q, l[b] = z;else if (p = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) {
                ...
                ea(c, n, a.axisY.reversed ? z : p, x, a.axisY.reversed ? p : z, b, 0, null, m && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && m, !1, !1, r.fillOpacity);
                b = r.dataPointIds[k];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
                ...
                b = P(b);
                w && ea(this._eventManager.ghostCtx, n, p, x, z, b, 0, null, !1, !1, !1, !1);
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (g = 0; g < a.dataSeriesIndexes.length; g++) {
          var h = a.dataSeriesIndexes[g],
              r = this.data[h],
              u = r.dataPoints;
          if (0 < u.length) for (var m = 5 < t && r.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++) {
            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
              n = a.axisX.convertValueToPixel(b);
              ...
              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                ...
                z = f[b] ? f[b] : q;
                f[b] = p;
              } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) D[b] = p + ("undefined" !== typeof D[b] ? D[b] : 0), z = a.axisY.convertValueToPixel(D[b]), p = l[b] ? l[b] : q, l[b] = z;else if (p = a.axisY.convertValueToPixel(p), 0 <= u[k].y) {
                var G = "undefined" !== typeof f[b] ? f[b] : 0;
                p -= G;
                z = q - G;
          ...
          if (0 < t.length) {
            ...
            for (f = 0; f < t.length; f++) {
              if (t[f].getTime ? D = t[f].x.getTime() : D = t[f].x, !(D < a.axisX.dataInfo.viewPortMin || D > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[f].y) {
                ...
                s = a.axisX.reversed ? s + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + n) * p << 0 : s - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount + n) * p << 0;
                var r = a.axisX.reversed ? s - p << 0 : s + p << 0,
                    u;
                0 <= t[f].y ? u = k : (u = l, l = k);
                b = t[f].color ? t[f].color : g._colorSet[f % g._colorSet.length];
                ea(c, a.axisY.reversed ? l : u, a.axisX.reversed ? r : s, a.axisY.reversed ? u : l, a.axisX.reversed ? s : r, b, 0, null, h, !1, !1, !1, g.fillOpacity);
                b = g.dataPointIds[f];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
                ...
                b = P(b);
                w && ea(this._eventManager.ghostCtx, u, a.axisX.reversed ? r : s, l, a.axisX.reversed ? s : r, b, 0, null, !1, !1, !1, !1);
                (t[f].indexLabel || g.indexLabel || t[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                  chartType: "bar",
                  dataPoint: t[f],
                  dataSeries: g,
    ...
    m.prototype.renderStackedBar = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b = null,
            ...
            t = a.axisX.dataInfo.minDiff;
        isFinite(t) || (t = 0.3 * Math.abs(a.axisX.range));
        t = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(t) / Math.log(a.axisX.range) : Math.abs(t) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
        this.dataPointMaxWidth && k > g && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, g));
        !this.dataPointMaxWidth && this.dataPointMinWidth && g < k && (g = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k));
        t < k && (t = k);
        t > g && (t = g);
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++) {
              if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                ...
                p = p - a.plotType.plotUnits.length * t / 2 + a.index * t << 0;
                var x = p + t << 0,
                    z;
                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) s[b] = u[k].y + (s[b] ? s[b] : 0), 0 < s[b] && (z = f[b] ? f[b] : q, f[b] = n = a.axisY.convertValueToPixel(s[b]));else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) D[b] = u[k].y + (D[b] ? D[b] : 0), n = l[b] ? l[b] : q, l[b] = z = a.axisY.convertValueToPixel(D[b]);else if (n = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) {
                  var G = f[b] ? f[b] : 0;
                  z = q + G;
                  n += G;
                  f[b] = G + (n - z);
                } else G = l[b] ? l[b] : 0, z = n - G, n = q - G, l[b] = G + (n - z);
                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                ea(c, a.axisY.reversed ? n : z, p, a.axisY.reversed ? z : n, x, b, 0, null, m, !1, !1, !1, r.fillOpacity);
                b = r.dataPointIds[k];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
                ...
                b = P(b);
                w && ea(this._eventManager.ghostCtx, z, p, n, x, b, 0, null, !1, !1, !1, !1);
                (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++) {
              if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                ...
                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) D[b] = x + (D[b] ? D[b] : 0), n = l[b] ? l[b] : q, l[b] = x = a.axisY.convertValueToPixel(D[b]);else if (n = a.axisY.convertValueToPixel(x), 0 <= u[k].y) {
                  var G = f[b] ? f[b] : 0;
                  x = q + G;
                  n += G;
                  a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.x2 - n) && (n = e.x2);
                  f[b] = G + (n - x);
                } else G = l[b] ? l[b] : 0, x = n - G, n = q - G, a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.x1 - x) && (x = e.x1), l[b] = G + (n - x);

                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                ea(c, a.axisY.reversed ? n : x, p, a.axisY.reversed ? x : n, z, b, 0, null, m, !1, !1, !1, r.fillOpacity);
                b = r.dataPointIds[k];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
                ...
                b = P(b);
                w && ea(this._eventManager.ghostCtx, x, p, n, z, b, 0, null, !1, !1, !1, !1);
                (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
    ...
    m.prototype.renderArea = function (a) {
      ...
      function b() {
        G && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? z = x : 0 > a.axisY.viewportMaximum ? z = s.y1 : 0 < a.axisY.viewportMinimum && (z = x), f.lineTo(r, z), f.lineTo(G.x, z), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (l.lineTo(r, z), l.lineTo(G.x, z), l.closePath(), l.fill()), f.beginPath(), f.moveTo(r, u), l.beginPath(), l.moveTo(r, u), G = {
          x: r,
          y: u
        });
      }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < t.length) {
            ...
            for (var ka = !0; h < t.length; h++) {
              if (m = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ka))) if ("number" !== typeof t[h].y) g.connectNullData || ka || d || b(), ka = !0;else {
                r = a.axisX.convertValueToPixel(m);
                u = a.axisY.convertValueToPixel(t[h].y);
                d || ka ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = r, c = u, r = n.x, u = n.y, b(), f.moveTo(n.x, n.y), r = d, u = c, G = n, c = g.nullDataLineDashType, f.setLineDash(M)), f.lineTo(r, u), w && l.lineTo(r, u)) : (f.beginPath(), f.moveTo(r, u), w && (l.beginPath(), l.moveTo(r, u)), G = {
                  x: r,
                  y: u
                }), ka = d = !1) : (f.lineTo(r, u), w && l.lineTo(r, u), 0 == h % 250 && b());
                n = {
                  x: r,
                  y: u
                };
                h < t.length - 1 && (A !== (t[h].lineColor || v) || c !== (t[h].lineDashType || g.lineDashType)) && (b(), A = t[h].lineColor || v, f.strokeStyle = A, f.setLineDash && (t[h].lineDashType ? (c = t[h].lineDashType, f.setLineDash(J(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(T))));
                ...
                0 !== t[h].markerSize && (0 < t[h].markerSize || 0 < g.markerSize) && (m = g.getMarkerProperties(h, r, u, f), D.push(m), aa = P(aa), w && D.push({
                  x: r,
                  y: u,
                  ctx: l,
                  type: m.type,
      ...
      function d() {
        ...
        if (0 < c.length) {
          ...
          for (d = 0; d < c.length - 3; d += 3) {
            b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), w && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y);
          }
        ...
        for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
          ...
          if (0 < p.length) {
            ...
            for (t = !1; q < p.length; q++) {
              if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !t))) if ("number" !== typeof p[q].y) 0 < q && !t && (n.connectNullData ? b.setLineDash && 0 < y.length && (n.options.nullDataLineDashType || !p[q - 1].lineDashType) && (y[y.length - 1].newLineDashArray = A, C = n.nullDataLineDashType) : (d(), y = [])), t = !0;else {
                g = a.axisX.convertValueToPixel(g);
                t = a.axisY.convertValueToPixel(p[q].y);
                var M = n.dataPointIds[q];
                ...
                q < p.length - 1 && (G !== (p[q].lineColor || z) || C !== (p[q].lineDashType || n.lineDashType)) && (G = p[q].lineColor || z, y[y.length - 1].newStrokeStyle = G, b.setLineDash && (p[q].lineDashType ? (C = p[q].lineDashType, y[y.length - 1].newLineDashArray = J(C, n.lineThickness)) : (C = n.lineDashType, y[y.length - 1].newLineDashArray = E)));

                if (0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < n.markerSize)) {
                  var T = n.getMarkerProperties(q, g, t, b);
                  l.push(T);
                  M = P(M);
                  w && l.push({
                    x: g,
    ...
    m.prototype.renderStepArea = function (a) {
      ...
      function b() {
        G && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? z = x : 0 > a.axisY.viewportMaximum ? z = s.y1 : 0 < a.axisY.viewportMinimum && (z = x), f.lineTo(m, z), f.lineTo(G.x, z), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (l.lineTo(m, z), l.lineTo(G.x, z), l.closePath(), l.fill()), f.beginPath(), f.moveTo(m, u), l.beginPath(), l.moveTo(m, u), G = {
          x: m,
          y: u
        });
      }
          ...
          if (0 < t.length) {
            ...
            if (f.setLineDash) {
              var T = J(g.nullDataLineDashType, g.lineThickness),
                  M = g.lineDashType,
                  B = J(M, g.lineThickness);
              f.setLineDash(B);
            }

            for (; r < t.length; r++) {
              if (y = t[r].x.getTime ? t[r].x.getTime() : t[r].x, !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                var aa = u;
                "number" !== typeof t[r].y ? (g.connectNullData || c || d || b(), c = !0) : (m = a.axisX.convertValueToPixel(y), u = a.axisY.convertValueToPixel(t[r].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || M === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = u, m = n.x, u = n.y, b(), f.moveTo(n.x, n.y), m = d, u = c, G = n, M = g.nullDataLineDashType, f.setLineDash(T)), f.lineTo(m, aa), f.lineTo(m, u), w && (l.lineTo(m, aa), l.lineTo(m, u))) : (f.beginPath(), f.moveTo(m, u), w && (l.beginPath(), l.moveTo(m, u)), G = {
                  x: m,
                  y: u
                }), c = d = !1) : (f.lineTo(m, aa), w && l.lineTo(m, aa), f.lineTo(m, u), w && l.lineTo(m, u), 0 == r % 250 && b()), n = {
                  x: m,
                  y: u
                }, r < t.length - 1 && (A !== (t[r].lineColor || v) || M !== (t[r].lineDashType || g.lineDashType)) && (b(), A = t[r].lineColor || v, f.strokeStyle = A, f.setLineDash && (t[r].lineDashType ? (M = t[r].lineDashType, f.setLineDash(J(M, g.lineThickness))) : (M = g.lineDashType, f.setLineDash(B)))), y = g.dataPointIds[r], this._eventManager.objectMap[y] = {
                  id: y,
                  objectType: "dataPoint",
                  dataSeriesIndex: q,
                  dataPointIndex: r,
                  x1: m,
                  y1: u
                }, 0 !== t[r].markerSize && (0 < t[r].markerSize || 0 < g.markerSize) && (aa = g.getMarkerProperties(r, m, u, f), h.push(aa), y = P(y), w && h.push({
                  x: m,
                  y: u,
                  ctx: l,
                  type: aa.type,
    ...
    m.prototype.renderStackedArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        b.rect(s.x1, s.y1, s.width, s.height);
        b.clip();
        w && (m.beginPath(), m.rect(s.x1, s.y1, s.width, s.height), m.clip());
        ...
        for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) {
          ...
          for (q = 0; q < v.length; q++) {
            G = v[q].x.getTime ? v[q].x.getTime() : v[q].x, C.dataPointIndexes[G] = q, e[G] || (n.push(G), e[G] = !0);
          }
        ...
        for (z = 0; z < a.dataSeriesIndexes.length; z++) {
          ...
          if (0 < n.length) {
            ...
            for (var aa = !0, q = 0; q < n.length; q++) {
              var f = n[q],
                  ga = null,
                  ga = 0 <= C.dataPointIndexes[f] ? v[C.dataPointIndexes[f]] : {
                x: f,
                y: null
              };
              if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !aa))) if ("number" !== typeof ga.y) C.connectNullData || aa || y || d(), aa = !0;else {
                ...
                } else t = a.axisY.convertValueToPixel(ga.y), t -= na;
                ...
                h[f] = r - t;
                y || aa ? (!y && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || x === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (y = k.pop(), x = k[k.length - 1], d(), b.moveTo(u.x, u.y), k.push(x), k.push(y), x = C.nullDataLineDashType, b.setLineDash(T)), b.lineTo(g, t), w && m.lineTo(g, t)) : (b.beginPath(), b.moveTo(g, t), w && (m.beginPath(), m.moveTo(g, t))), aa = y = !1) : (b.lineTo(g, t), w && m.lineTo(g, t), 0 == q % 250 && (d(), b.moveTo(g, t), w && m.moveTo(g, t), k.push({
                  x: g,
                  y: r - na
                })));
                u = {
                ...
                q < v.length - 1 && (M !== (v[q].lineColor || A) || x !== (v[q].lineDashType || C.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, t), k.push({
                  x: g,
                  y: r - na
                }), M = v[q].lineColor || A, b.strokeStyle = M, b.setLineDash && (v[q].lineDashType ? (x = v[q].lineDashType, b.setLineDash(J(x, C.lineThickness))) : (x = C.lineDashType, b.setLineDash(B))));
                ...
                0 <= C.dataPointIndexes[f] && 0 !== ga.markerSize && (0 < ga.markerSize || 0 < C.markerSize) && (na = C.getMarkerProperties(C.dataPointIndexes[f], g, t, b), l.push(na), f = P(E), w && l.push({
                  x: g,
                  y: t,
                  ctx: m,
                  type: na.type,
        ...
        ba.drawMarkers(l);
        w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(s.x1, s.y1, s.width, s.height), m.restore());
        b.restore();
        return {
          source: c,
          dest: this.plotArea.ctx,
        ...
        for (z = 0; z < a.dataSeriesIndexes.length; z++) {
          ...
          if (0 < n.length) {
            ...
            for (var aa = !0, q = 0; q < n.length; q++) {
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !aa))) if ("number" !== typeof ga.y) C.connectNullData || aa || m || d(), aa = !0;else {
                var na;
                ...
                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                  ...
                  if (0 >= p[f] && a.axisY.logarithmic) continue;
                  t = a.axisY.convertValueToPixel(p[f]);
                } else t = a.axisY.convertValueToPixel(na), t -= E;
                ...
                h[f] = y - t;
                m || aa ? (!m && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || u === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (m = k.pop(), u = k[k.length - 1], d(), b.moveTo(r.x, r.y), k.push(u), k.push(m), u = C.nullDataLineDashType, b.setLineDash(T)), b.lineTo(g, t), w && x.lineTo(g, t)) : (b.beginPath(), b.moveTo(g, t), w && (x.beginPath(), x.moveTo(g, t))), aa = m = !1) : (b.lineTo(g, t), w && x.lineTo(g, t), 0 == q % 250 && (d(), b.moveTo(g, t), w && x.moveTo(g, t), k.push({
                  x: g,
                  y: y - E
                })));
                r = {
                ...
                q < v.length - 1 && (M !== (v[q].lineColor || A) || u !== (v[q].lineDashType || C.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, t), k.push({
                  x: g,
                  y: y - E
                }), M = v[q].lineColor || A, b.strokeStyle = M, b.setLineDash && (v[q].lineDashType ? (u = v[q].lineDashType, b.setLineDash(J(u, C.lineThickness))) : (u = C.lineDashType, b.setLineDash(B))));
                ...
                0 <= C.dataPointIndexes[f] && 0 !== ga.markerSize && (0 < ga.markerSize || 0 < C.markerSize) && (E = C.getMarkerProperties(q, g, t, b), s.push(E), f = P(F), w && s.push({
                  x: g,
                  y: t,
                  ctx: x,
                  type: E.type,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var s = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++) {
          for (var n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, g = 0, e = 0; e < q.length; e++) {
            f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (g = q[e].z, g > s && (s = g), g < h && (h = g));
          }
        }
        ...
        for (var t = 25 * Math.PI, r = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, t), k = 0; k < a.dataSeriesIndexes.length; k++) {
          if (n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, 0 < q.length) for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++) {
            if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
              ...
              m = P(u);
              w && ba.drawMarker(f, l, this._eventManager.ghostCtx, g.type, g.size, m, m, g.borderThickness);
            ...
            for (var p = 0, q = 0, e = 0; e < n.length; e++) {
              if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                ...
                Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = k.dataPointIds[e], this._eventManager.objectMap[p] = {
                  ...
                  x1: f,
                  y1: l
                }, p = P(p), w && ba.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness), (n[e].indexLabel || k.indexLabel || n[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                  chartType: "scatter",
                  dataPoint: n[e],
                  dataSeries: k,
                  point: {
    ...
    m.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          var fa = a.dataSeriesIndexes[m],
              u = this.data[fa],
              y = u.dataPoints;
          if (0 < y.length) for (var x = 5 < t && u.bevelEnabled ? !0 : !1, s = 0; s < y.length; s++) {
    ...
    m.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = !1, m = !!a.axisY.reversed, fa = 0; fa < a.dataSeriesIndexes.length; fa++) {
          var u = a.dataSeriesIndexes[fa],
              y = this.data[u],
              x = y.dataPoints;
          if (0 < x.length) for (var z = 5 < t && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++) {
            if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3] && "number" === typeof x[l].y[4] && 5 === x[l].y.length) {
              ...
              var G = s - t / 2 << 0,
                  ...
                  T = "number" === typeof x[l].whiskerThickness ? x[l].whiskerThickness : "number" === typeof y.options.whiskerThickness ? y.whiskerThickness : v,
                  B = x[l].whiskerDashType ? x[l].whiskerDashType : y.whiskerDashType,
                  aa = r(x[l].whiskerLength) ? r(y.options.whiskerLength) ? t : y.whiskerLength : x[l].whiskerLength,
                  aa = "number" === typeof aa ? 0 >= aa ? 0 : aa >= t ? t : aa : "string" === typeof aa ? parseInt(aa) * t / 100 > t ? t : parseInt(aa) * t / 100 : t,
                  ...
                  E = "number" === typeof x[l].stemThickness ? x[l].stemThickness : "number" === typeof y.options.stemThickness ? y.stemThickness : v,
                  F = 1 === Math.round(E) % 2 ? 0.5 : 0,
                  I = x[l].stemDashType ? x[l].stemDashType : y.stemDashType,
                  K = x[l].lineColor ? x[l].lineColor : x[l].color ? y.lineColor ? y.lineColor : x[l].color : y.lineColor ? y.lineColor : e,
                  O = "number" === typeof x[l].lineThickness ? x[l].lineThickness : "number" === typeof y.options.lineThickness ? y.lineThickness : v,
                  R = x[l].lineDashType ? x[l].lineDashType : y.lineDashType,
                  L = 1 === Math.round(O) % 2 ? 0.5 : 0,
                  S = y.upperBoxColor,
                  U = y.lowerBoxColor,
                  sa = r(y.options.fillOpacity) ? 1 : y.fillOpacity,
                  Q = y.dataPointIds[l];
              this._eventManager.objectMap[Q] = {
                id: Q,
                objectType: "dataPoint",
              ...
              c.save();
              0 < E && (c.beginPath(), c.strokeStyle = na, c.lineWidth = E, c.setLineDash && c.setLineDash(J(I, E)), c.moveTo(s - F, k), c.lineTo(s - F, h), c.stroke(), c.moveTo(s - F, p), c.lineTo(s - F, n), c.stroke());
              c.restore();
              b.lineWidth = Math.max(v, 4);
              c.beginPath();
              ea(c, G, Math.min(q, k), C, Math.max(k, q), U, 0, e, m ? z : !1, m ? !1 : z, !1, !1, sa);
              c.beginPath();
              ea(c, G, Math.min(n, q), C, Math.max(q, n), S, 0, e, m ? !1 : z, m ? z : !1, !1, !1, sa);
              c.beginPath();
              c.lineWidth = v;
              c.strokeStyle = e;
              c.rect(G - A, Math.min(k, n) - A, C - G + 2 * A, Math.max(k, n) - Math.min(k, n) + 2 * A);
              c.stroke();
              c.save();
              0 < O && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(J(R, O)), c.strokeStyle = K, c.lineWidth = O, c.moveTo(G, q - L), c.lineTo(C, q - L), c.stroke());
              c.restore();
              c.save();
              0 < T && (c.beginPath(), c.setLineDash && c.setLineDash(J(B, T)), c.strokeStyle = M, c.lineWidth = T, c.moveTo(s - aa / 2 << 0, p - ga), c.lineTo(s + aa / 2 << 0, p - ga), c.stroke(), c.moveTo(s - aa / 2 << 0, h + ga), c.lineTo(s + aa / 2 << 0, h + ga), c.stroke());
              c.restore();
              w && (e = P(Q), b.strokeStyle = e, b.lineWidth = E, 0 < E && (b.moveTo(s - A - F, k), b.lineTo(s - A - F, Math.max(h, p)), b.stroke(), b.moveTo(s - A - F, Math.min(h, p)), b.lineTo(s - A - F, n), b.stroke()), ea(b, G, Math.max(k, n), C, Math.min(k, n), e, 0, null, !1, !1, !1, !1), 0 < T && (b.beginPath(), b.lineWidth = T, b.moveTo(s + aa / 2, p - ga), b.lineTo(s - aa / 2, p - ga), b.stroke(), b.moveTo(s + aa / 2, h + ga), b.lineTo(s - aa / 2, h + ga), b.stroke()));
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          var p = a.dataSeriesIndexes[n],
              q = this.data[p],
              g = q.dataPoints;
          if (0 < g.length) for (var t = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++) {
            if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !r(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
              ...
              var m = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + n) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + n) * k << 0,
                  fa = a.axisX.reversed ? m - k << 0 : m + k << 0,
              ...
              ea(c, a.axisX.reversed ? fa : m, l, a.axisX.reversed ? m : fa, s, b, 0, b, t, t, !1, !1, q.fillOpacity);
              b = P(u);
              w && ea(this._eventManager.ghostCtx, a.axisX.reversed ? fa : m, l, a.axisX.reversed ? m : fa, s, b, 0, null, !1, !1, !1, !1);
    ...
    m.prototype.renderError = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var fa = 0, u = 0; u < this.data.length; u++) {
          !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && fa || fa++;
        }
        ...
        for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
          var x = a.dataSeriesIndexes[y],
              ...
              A = 0;
          if (C) for (e = z._linkedSeries.id, u = 0; u < e; u++) {
            !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && A || (this.data[u].type.match(/(range)/ig) && (f = !0), A++);
          }
          e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
          s = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (C ? fa : 1))) << 0 : 0.3 * this.width;
          f && (s = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (C ? fa : 1))) << 0 : 0.03 * this.width);
          u = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / (C ? fa : 1)) << 0;
          ...
          u < e && (u = e);
          u > s && (u = s);
          if (0 < v.length) for (var B = z._colorSet, s = 0; s < v.length; s++) {
            var e = z.lineColor = z.options.color ? z.options.color : B[0],
                M = {
              color: v[s].whiskerColor ? v[s].whiskerColor : v[s].color ? z.whiskerColor ? z.whiskerColor : v[s].color : z.whiskerColor ? z.whiskerColor : e,
              thickness: r(v[s].whiskerThickness) ? z.whiskerThickness : v[s].whiskerThickness,
              dashType: v[s].whiskerDashType ? v[s].whiskerDashType : z.whiskerDashType,
              length: r(v[s].whiskerLength) ? r(z.options.whiskerLength) ? u : z.options.whiskerLength : v[s].whiskerLength,
              trimLength: r(v[s].whiskerLength) ? r(z.options.whiskerLength) ? 50 : 0 : 0
            };
            ...
            var T = {
              color: v[s].stemColor ? v[s].stemColor : v[s].color ? z.stemColor ? z.stemColor : v[s].color : z.stemColor ? z.stemColor : e,
              thickness: v[s].stemThickness ? v[s].stemThickness : z.stemThickness,
              dashType: v[s].stemDashType ? v[s].stemDashType : z.stemDashType
            };
            T.thickness = "number" === typeof T.thickness ? 0 > T.thickness ? 0 : Math.round(T.thickness) : 2;
            v[s].getTime ? t = v[s].x.getTime() : t = v[s].x;

            if (!(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && !r(v[s].y) && v[s].y.length && "number" === typeof v[s].y[0] && "number" === typeof v[s].y[1]) {
              var ka = a.axisX.convertValueToPixel(t);
              b ? k = ka : h = ka;
              ka = a.axisY.convertValueToPixel(v[s].y[0]);
              b ? n = ka : q = ka;
              ka = a.axisY.convertValueToPixel(v[s].y[1]);
              b ? p = ka : g = ka;
              b ? (q = a.axisX.reversed ? k + (C ? fa : 1) * u / 2 - (C ? A - 1 : 0) * u << 0 : k - (C ? fa : 1) * u / 2 + (C ? A - 1 : 0) * u << 0, g = a.axisX.reversed ? q - u << 0 : q + u << 0) : (n = a.axisX.reversed ? h + (C ? fa : 1) * u / 2 - (C ? A - 1 : 0) * u << 0 : h - (C ? fa : 1) * u / 2 + (C ? A - 1 : 0) * u << 0, p = a.axisX.reversed ? n - u << 0 : n + u << 0);
              !b && q > g && (ka = q, q = g, g = ka);
              b && n > p && (ka = n, n = p, p = ka);
              ka = z.dataPointIds[s];
              ...
              E(c, Math.min(n, p), Math.min(q, g), Math.max(p, n), Math.max(g, q), e, M, T, b);
              w && E(this._eventManager.ghostCtx, n, q, p, g, e, M, T, b);
              if (v[s].indexLabel || z.indexLabel || v[s].indexLabelFormatter || z.indexLabelFormatter) this._indexLabels.push({
                chartType: "error",
                dataPoint: v[s],
                dataSeries: z,
                indexKeyword: 0,
                point: {
                  x: b ? v[s].y[1] >= v[s].y[0] ? n : p : n + (p - n) / 2,
                ...
                indexKeyword: 1,
                point: {
                  x: b ? v[s].y[1] >= v[s].y[0] ? p : n : n + (p - n) / 2,
          ...
          if (0 < t.length) {
            ...
            for (f = 0; f < t.length; f++) {
              if (t[f].getTime ? k = t[f].x.getTime() : k = t[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(t[f].y) && t[f].y.length && "number" === typeof t[f].y[0] && "number" === typeof t[f].y[1]) {
                ...
                l > s && (b = l, l = s, s = b);
                b = t[f].color ? t[f].color : g._colorSet[f % g._colorSet.length];
                ea(c, l, a.axisX.reversed ? v : h, s, a.axisX.reversed ? h : v, b, 0, null, m, !1, !1, !1, g.fillOpacity);
                b = g.dataPointIds[f];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
                ...
                b = P(b);
                w && ea(this._eventManager.ghostCtx, l, a.axisX.reversed ? v : h, s, a.axisX.reversed ? h : v, b, 0, null, !1, !1, !1, !1);
        ...
        for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < p.length) {
            ...
            for (var M = !0; g < p.length; g++) {
              if (u = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !M))) if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                t = a.axisX.convertValueToPixel(u);
                r = a.axisY.convertValueToPixel(p[g].y[0]);
                m = a.axisY.convertValueToPixel(p[g].y[1]);
                q || M ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || C === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = B, C = n.nullDataLineDashType, b.setLineDash(A)), b.lineTo(t, r), w && e.lineTo(t, r), h.push({
                  x: t,
                  y1: r,
                  y2: m
                  ...
                  y1: r,
                  y2: m
                }), w && (e.beginPath(), e.moveTo(t, r))), M = q = !1) : (b.lineTo(t, r), h.push({
                  x: t,
                  y1: r,
                  y2: m
                }), w && e.lineTo(t, r), 0 == g % 250 && d());
                u = n.dataPointIds[g];
                this._eventManager.objectMap[u] = {
                  id: u,
                  objectType: "dataPoint",
                ...
                g < p.length - 1 && (v !== (p[g].lineColor || z) || C !== (p[g].lineDashType || n.lineDashType)) && (d(), v = p[g].lineColor || z, h[h.length - 1].newStrokeStyle = v, b.strokeStyle = v, b.setLineDash && (p[g].lineDashType ? (C = p[g].lineDashType, h[h.length - 1].newLineDashArray = J(C, n.lineThickness), b.setLineDash(h[h.length - 1].newLineDashArray)) : (C = n.lineDashType, h[h.length - 1].newLineDashArray = B, b.setLineDash(B))));

                if (0 !== p[g].markerSize && (0 < p[g].markerSize || 0 < n.markerSize)) {
                  var T = n.getMarkerProperties(g, t, m, b);
                  f.push(T);
                  var E = P(u);
                  w && f.push({
                    x: t,
                  ...
                  T = n.getMarkerProperties(g, t, r, b);
                  f.push(T);
                  E = P(u);
                  w && f.push({
                    x: t,
      ...
      function d(a, c) {
        ...
        if (0 < d.length) {
          ...
          for (f = 0; f < d.length - 3; f += 3) {
            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y), w && e.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y);
          }
          ...
          if (0 < n.length) {
            ...
            for (g = !1; p < n.length; p++) {
              if (q = n[p].x.getTime ? n[p].x.getTime() : n[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g))) if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" === typeof n[p].y[1]) {
                ...
                p < n.length - 1 && (x !== (n[p].lineColor || y) || z !== (n[p].lineDashType || k.lineDashType)) && (x = n[p].lineColor || y, r[r.length - 1].newStrokeStyle = x, b.setLineDash && (n[p].lineDashType ? (z = n[p].lineDashType, r[r.length - 1].newLineDashArray = J(z, k.lineThickness)) : (z = k.lineDashType, r[r.length - 1].newLineDashArray = A)));
                ...
                g = !1;
              } else 0 < p && !g && (k.connectNullData ? b.setLineDash && 0 < r.length && (k.options.nullDataLineDashType || !n[p - 1].lineDashType) && (r[r.length - 1].newLineDashArray = C, z = k.nullDataLineDashType) : (d(A, y), r = [], m = [])), g = !0;
            }
    ...
    m.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < m.length) for (var x = 5 < q && r.bevelEnabled ? !0 : !1, v = !1, A = null, C = null, l = 0; l < m.length; l++) {
            if (m[l].getTime ? n = m[l].x.getTime() : n = m[l].x, "number" !== typeof m[l].y) {
              if (0 < l && !v && r.connectNullData) var E = r.options.nullDataLineDashType || !m[l - 1].lineDashType ? r.nullDataLineDashType : m[l - 1].lineDashType;
              v = !0;
            } else {
              ...
              var B = a.axisX.reversed ? s - q << 0 : s + q << 0;
              h > k && (e = h, h = k, k = e);
              ...
              var M = m[l].color ? m[l].color : 0 < m[l].y ? r.risingColor : r.fallingColor;
              ea(c, a.axisX.reversed ? B : s, a.axisY.reversed ? k : h, a.axisX.reversed ? s : B, a.axisY.reversed ? h : k, M, 0, M, x, x, !1, !1, r.fillOpacity);
              e = P(e);
              w && ea(this._eventManager.ghostCtx, a.axisX.reversed ? B : s, h, a.axisX.reversed ? s : B, k, e, 0, null, !1, !1, !1, !1);
              var T,
                  M = s;
              T = "undefined" !== typeof m[l].isIntermediateSum && !0 === m[l].isIntermediateSum || "undefined" !== typeof m[l].isCumulativeSum && !0 === m[l].isCumulativeSum ? 0 < m[l].y ? h : k : 0 < m[l].y ? k : h;
              0 < l && A && (!v || r.connectNullData) && (v && c.setLineDash && c.setLineDash(J(E, u)), c.beginPath(), c.moveTo(A, C - y), c.lineTo(M, T - y), 0 < u && c.stroke(), w && (b.beginPath(), b.moveTo(A, C - y), b.lineTo(M, T - y), 0 < u && b.stroke()));
              v = !1;
              A = B;
              C = 0 < m[l].y ? h : k;
              M = m[l].lineDashType ? m[l].lineDashType : r.options.lineDashType ? r.options.lineDashType : "shortDash";
    ...
    var ia = function ia(a, d, c, b, e, f, l, h, r) {
      if (!(0 > c)) {
        ...
        a.save();
        a.globalAlpha = h;
        "pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, l, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, l, !1), 0 <= r && a.arc(d.x, d.y, r * c, l, f, !0), a.closePath(), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
        a.globalAlpha = 1;
        a.restore();
      }
    };
    ...
    m.prototype.renderPie = function (a) {
      function d() {
        if (k && n) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
            ...
            h.indexLabelTextBlock = new ja(m.plotArea.ctx, {
          ...
          for (e = 0; e < n.length; e++) {
            h = g[(c + e) % n.length], 1 < a && h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI / 2 + u && (f <= a / 2 && !p ? (h.hemisphere = "right", f++) : (h.hemisphere = "left", p = !0));
          }
      ...
      function c(a) {
        ...
        for (b = 0; b < n.length; b++) {
          ...
          if (d > c) {
            ...
            ia(m.plotArea.ctx, g[b].center, g[b].radius, n[b].color ? n[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, g[b].percentInnerRadius);
          }
        }
        ...
        if (0 <= a && a < n.length) {
          ...
          for (h = 1; h < n.length; h++) {
            if (k = (a - h + g.length) % g.length, g[k].hemisphere !== g[a].hemisphere) {
              k = null;
              break;
            } else if (g[k].indexLabelText && g[k].hemisphere === g[a].hemisphere && k !== a && (0 > b(g[k], g[a]) || ("right" === g[a].hemisphere ? g[k].indexLabelTextBlock.y <= g[a].indexLabelTextBlock.y : g[k].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y))) break;else k = null;
          }

          s = k;
          q = e(a);
          h = k = 0;
          0 > c ? (h = "right" === p.hemisphere ? s : q, l = c, null !== h && (s = -c, c = p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - (g[h].indexLabelTextBlock.y + g[h].indexLabelTextBlock.height / 2), c - s < t && (k = -s, h = f(h, k, d + 1), +h.toFixed(y) > +k.toFixed(y) && (l = c > t ? -(c - t) : -(s - (h - k)))))) : 0 < c && (h = "right" === p.hemisphere ? q : s, l = c, null !== h && (s = c, c = g[h].indexLabelTextBlock.y - g[h].indexLabelTextBlock.height / 2 - (p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2), c - s < t && (k = s, h = f(h, k, d + 1), +h.toFixed(y) < +k.toFixed(y) && (l = c > t ? c - t : s - (k - h)))));
          ...
          if ("inside" !== k.indexLabelPlacement) {
            ...
            for (var s, r, a = 0; a < n.length; a++) {
              ...
              if (null !== u) {
                ...
                if (0 > z) {
                  for (var A = r = 0, G = 0; G < n.length; G++) {
                    G !== a && g[G].hemisphere === h.hemisphere && (g[G].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? r++ : A++);
                  }
            ...
            h = g[a], w = "pie" === k.type ? 0.7 * C : 0.8 * C, u = x.x + w * Math.cos(h.midAngle), r = x.y + w * Math.sin(h.midAngle), h.indexLabelTextBlock.x = u, h.indexLabelTextBlock.y = r;
          }
              ...
              if (f = !1, s = g[k], s.indexLabelText) {
                ...
                if (null !== l) {
                  ...
                  if (q = 0 > z) {
                    ...
                    q = s.indexLabelTextBlock.x + s.indexLabelTextBlock.width < h.indexLabelTextBlock.x - p || q > u + p || r > D + p || m < t - p ? !1 : !0;
                  }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var A = 0; A < n.length; A++) {
          z += Math.abs(n[A].y), !a && "undefined" !== typeof n[A].indexLabel && null !== n[A].indexLabel && 0 < n[A].indexLabel.toString().length && (a = !0), !a && "undefined" !== typeof n[A].label && null !== n[A].label && 0 < n[A].label.toString().length && (a = !0);
        }
        ...
        if (0 !== z) {
          ...
          this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
            ...
            for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < n.length; c++) {
              ...
              e > d && ia(m.plotArea.ctx, g[c].center, g[c].radius, l, k.type, d, e, k.fillOpacity, g[c].percentInnerRadius);
              if (f) break;
            }
    ...
    m.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        for (var l = d[0] = 0, h = 0, n, p, b = b - a, l = !1, k = 0; k < y.length; k++) {
          a = Math.abs(y[k].y) * f / g, l ? n = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = $ * $ * b * b - 4 * Math.abs($) * a, 0 > p ? (p = c, l = (b + p) * (e - h) / 2, a -= l, n = e - h, h += e - h, n += 0 == p ? 0 : a / p, h += a / p, l = !0) : (n = (Math.abs($) * b - Math.sqrt(p)) / 2, p = b - 2 * n / Math.abs($), h += n, h > e && (h -= n, p = c, l = (b + p) * (e - h) / 2, a -= l, n = e - h, h += e - h, n += a / p, h += a / p, l = !0), b = p)), d.push(n);
        }
      ...
      function b() {
        if (u && y) {
          for (var a, b, c, d, e, f, k, l, h, n, p, q, s, m, t, D = [], x = [], v = {
            percent: null,
            total: null
          }, z = null, C = 0; C < y.length; C++) {
            t = Q[C], t = "undefined" !== typeof t.x5 ? (t.y2 + t.y4) / 2 : (t.y2 + t.y3) / 2, t = g(t).x2 + 1, D[C] = K - t - W;
          }
          ...
          for (var C = 0, B = y.length - 1; C < y.length || 0 <= B; C++, B--) {
            ...
            "inside" === u.indexLabelPlacement && (D[C] = C !== ca ? u.reversed ? Q[C].x2 - Q[C].x1 : Q[C].x3 - Q[C].x4 : Q[C].x3 - Q[C].x6, 20 > D[C] && (D[C] = C !== ca ? u.reversed ? Q[C].x3 - Q[C].x4 : Q[C].x2 - Q[C].x1 : Q[C].x2 - Q[C].x1, D[C] /= 2));
            s = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth : D[C];
            if (s > D[C] || 0 > s) s = D[C];
      ...
      function e() {
        ...
        for (var g, k = K - X - W / 2, k = u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth > k ? k : u.indexLabelMaxWidth : k, l = H.length - 1; 0 <= l; l--) {
          g = y[H[l].id];
          c = H[l];
          d = c.textBlock;
        ...
        if (e) for (l = H.length - 1; 0 <= l; l--) {
          a = Q[l], H[l].textBlock.maxWidth = f[f.length - (l + 1)], H[l].textBlock.measureText(), H[l].textBlock.x = K - k, c = H[l].textBlock.height < H[l].textBlock.maxHeight ? H[l].textBlock.height : H[l].textBlock.maxHeight, e = H[l].textBlock.width < H[l].textBlock.maxWidth ? H[l].textBlock.width : H[l].textBlock.maxWidth, H[l].height = c, H[l].width = e, c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, H[l].textBlock.y = c - H[l].height / 2, u.reversed ? (H[l].textBlock.y + H[l].height > oa + z && (H[l].textBlock.y = oa + z - H[l].height), H[l].textBlock.y < sa - z && (H[l].textBlock.y = sa - z)) : (H[l].textBlock.y < oa - z && (H[l].textBlock.y = oa - z), H[l].textBlock.y + H[l].height > sa + z && (H[l].textBlock.y = sa + z - H[l].height));
        }
      }

      function f() {
        var a, b, c, d;
        if ("inside" !== u.indexLabelPlacement) for (var e = 0; e < Q.length; e++) {
          0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = Q[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = u.reversed ? "undefined" !== typeof a.x5 ? c > Ba ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < Ba ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, H[e].textBlock.x = b + W, H[e].textBlock.y = c - H[e].height / 2, u.reversed ? (H[e].textBlock.y + H[e].height > oa + z && (H[e].textBlock.y = oa + z - H[e].height), H[e].textBlock.y < sa - z && (H[e].textBlock.y = sa - z)) : (H[e].textBlock.y < oa - z && (H[e].textBlock.y = oa - z), H[e].textBlock.y + H[e].height > sa + z && (H[e].textBlock.y = sa + z - H[e].height)));
        } else for (e = 0; e < Q.length; e++) {
          0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = Q[e], b = a.height, c = H[e].height, d = H[e].width, b >= c ? (b = e != ca ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e != ca ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, H[e].textBlock.x = b, H[e].textBlock.y = c) : H[e].isDirty = !0);
        }
      }
      ...
      function l() {
        ...
        function b() {
          ...
          for (var k, h = 1; h < l; h++) {
            ...
            for (var s = H.length - 1; 0 <= s; s--) {
              !H[s].isDirty && H[s].textBlock.y < e && H[s].textBlock.y + H[s].height > e && (k = q(s), !(k >= H.length - 1) && H[s].textBlock.y + H[s].height + da > H[k].textBlock.y && (H[s].textBlock.y = H[s].textBlock.y + H[s].height - e > e - H[s].textBlock.y ? e + 1 : e - H[s].height - 1));
            }
          }
          ...
          for (k = Q.length - 1; 0 < k; k--) {
            if (!H[k].isDirty) {
              ...
              if (H[k].textBlock.y < H[e].textBlock.y + H[e].height) {
                ...
                for (l = 0; H[f].textBlock.y < H[e].textBlock.y + H[e].height + da;) {
        ...
        function c(a, b, d) {
          ...
          for (d = 0; d < e.length; d++) {
            if (b = e[d], f < a) g++, f += H[b.id].height + da, H[b.id].textBlock.text = "", H[b.id].indexLabelText = "", H[b.id].isDirty = !0, H[b.id].textBlock.measureText();else break;
          }
        ...
        for (var d, e, f, g, l, k, n = 1, r = 0; r < 2 * n; r++) {
          for (var m = H.length - 1; 0 <= m && !(0 <= p(m) && p(m), f = H[m], g = f.textBlock, k = (l = q(m) < Q.length ? H[q(m)] : null) ? l.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && l && e + d + da > +k.y.toFixed(6) && (d = g.y + d + da - k.y, e = a(m, -d), e < d && (0 < e && (d -= e), e = a(q(m), d), e != d))); m--) {
            ;
          }
      ...
      function h(a, b) {
        return (b < Q.length ? H[b].textBlock.y : u.reversed ? oa + z : sa + z) - (0 > a ? u.reversed ? sa - z : oa - z : H[a].textBlock.y + H[a].height + da);
      }
      ...
      function m(a, b, c) {
        ...
        if (0 === Y.length) l = ia;else {
          e = z * (1 != Y.length || 0 != Y[0] && Y[0] != Q.length - 1 ? 2 : 1) / k();
          ...
          for (var s = 0; s < Q.length; s++) {
            ...
            l.push(ia[s] + d);
            if (0 <= Y.indexOf(s) || s < Q.length && 0 <= Y.indexOf(s + 1)) d += e;
          }
        }
        ...
        var q = {
          ...
          changeSection: function changeSection(a) {
            for (var b, c, d = 0; d < Q.length; d++) {
              b = g[d], c = Q[d], b *= a, "undefined" === typeof p[d] && (p[d] = 0), 0 > p && (p *= -1), c.y1 += b - p[d], c.y2 += b - p[d], c.y3 += b - p[d], c.y4 += b - p[d], c.y5 && (c.y5 += b - p[d], c.y6 += b - p[d]), p[d] = b;
            }
          }
        };
        ...
        a._animator.animate(0, c, function (c) {
          ...
          v(d);
          M && ("inside" !== u.indexLabelPlacement ? n(d) : f(), t(d));
          1 <= c && (ha = !1);
      ...
      function v(a) {
        ...
        if (A.subtitles) for (var b = 0; b < A.subtitles.length; b++) {
          var c = A.subtitles[b];
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, x = this.plotArea, z = 0.025 * x.width, B = 0.01 * x.width, C = 0, E = x.height - 2 * z, I = Math.min(x.width - 2 * B, 2.8 * x.height), M = !1, T = 0; T < y.length; T++) {
        ...
        "inside" !== u.indexLabelPlacement && M || (B = (x.width - 0.75 * I) / 2);
        var T = x.x1 + B,
            K = x.x2 - B,
            O = x.y1 + z,
            R = x.y2 - z,
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
          ...
          a = 75 * I / 100;
          var W = 30 * (K - a) / 100;
          "funnel" === u.type ? (P = r(u.options.neckHeight) ? 0.35 * E : u.neckHeight, F = r(u.options.neckWidth) ? 0.25 * a : u.neckWidth, "string" === typeof P && P.match(/%$/) ? (P = parseInt(P), P = P * E / 100) : P = parseInt(P), "string" === typeof F && F.match(/%$/) ? (F = parseInt(F), F = F * a / 100) : F = parseInt(F), P > E ? P = E : 0 >= P && (P = 0), F > a ? F = a - 0.5 : 0 >= F && (F = 0)) : "pyramid" === u.type && (F = P = 0, u.reversed = u.reversed ? !1 : !0);
          var B = T + a / 2,
              Z = T,
              X = T + a,
              oa = u.reversed ? R : O,
          ...
          if (-1 !== T) {
            if (u.reversed) for (I.push(V), F = T.length - 1; 0 < F; F--) {
              V += T[F], I.push(V);
            } else for (F = 0; F < T.length; F++) {
              V += T[F], I.push(V);
            }
            if (u.reversed) for (F = 0; F < T.length; F++) {
              I[F] < Ba ? (a.push(L), B.push(ba), ca = F) : (a.push((I[F] - oa + $ * Z) / $), B.push((I[F] - oa + ea * X) / ea));
            } else for (F = 0; F < T.length; F++) {
              I[F] < Ba ? (a.push((I[F] - oa + $ * Z) / $), B.push((I[F] - oa + ea * X) / ea), ca = F) : (a.push(L), B.push(ba));
            }

            for (F = 0; F < T.length - 1; F++) {
              V = u.reversed ? y[y.length - 1 - F].color ? y[y.length - 1 - F].color : u._colorSet[(y.length - 1 - F) % u._colorSet.length] : y[F].color ? y[F].color : u._colorSet[F % u._colorSet.length], F === ca ? Q.push({
                x1: a[F],
                y1: I[F],
                x2: B[F],
                y2: I[F],
            ...
            for (F = 0; F < y.length; F++) {
              y[F].exploded && (T = !0, u.reversed ? Y.push(y.length - 1 - F) : Y.push(F));
            }

            S.clearRect(x.x1, x.y1, x.width, x.height);
            S.fillStyle = A.backgroundColor;
            S.fillRect(x.x1, x.y1, x.width, x.height);

            if (M && u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) {
              l();

              for (F = 0; F < y.length; F++) {
                H[F].isDirty || (a = H[F].textBlock.x + H[F].width, a = (K - a) / 2, 0 == F && (C = a), C > a && (C = a));
              }

              for (F = 0; F < Q.length; F++) {
                Q[F].x1 += C, Q[F].x2 += C, Q[F].x3 += C, Q[F].x4 += C, Q[F].x5 && (Q[F].x5 += C, Q[F].x6 += C), H[F].textBlock.x += C;
              }
            }

            for (F = 0; F < Q.length; F++) {
              C = Q[F], qa(S, C, u.fillOpacity), ia.push(C.y1);
            }

            v(S);
            M && u.visible && ("inside" === u.indexLabelPlacement || A.animationEnabled || n(S), A.animationEnabled || t());
            if (!M) for (F = 0; F < y.length; F++) {
              C = u.dataPointIds[F], a = {
                id: C,
                objectType: "dataPoint",
                dataPointIndex: F,
                dataSeriesIndex: 0,
                funnelSection: Q[u.reversed ? y.length - 1 - F : F]
              }, A._eventManager.objectMap[C] = a;
            }
            !A.animationEnabled && T ? m(A, -1, 0) : A.animationEnabled && !A.animatedRender && m(A, -1, 0);
    ...
    m.prototype.exportChart = function (a) {
      ...
      if (b && d && c) {
        ...
        if ("undefined" !== typeof Blob && new Blob()) {
          for (var l = b.replace(/^data:[a-z\/]*;base64,/, ""), l = atob(l), h = new ArrayBuffer(l.length), h = new Uint8Array(h), r = 0; r < l.length; r++) {
            h[r] = l.charCodeAt(r);
          }
    ...
    m.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
      ...
      if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
        ...
        do {
          r = "";
          if (c.percentFormatString) r = c.percentFormatString;else {
            var r = "#,##0.",
          ...
          a = a.replace("#percent", da(l, r, f._cultureInfo));
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
        ...
        } else return "y" === a ? da(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" === a ? da(g, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", f._cultureInfo) : g;
      });
    };
    ...
    R.prototype.setLayout = function () {
      ...
      var m = [],
          k = [];
      if ("top" === this.verticalAlign || "bottom" === this.verticalAlign) this.orientation = "horizontal", c = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, l = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height;else if ("center" === this.verticalAlign) {
      ...
      for (var n = 0; n < this.dataSeries.length; n++) {
        ...
        if (p.dataPoints && p.dataPoints.length) if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
          var q = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? "error" === p.type && p._linkedSeries ? p._linkedSeries.legendMarkerType ? p._linkedSeries.legendMarkerType : S.getDefaultLegendMarker(p._linkedSeries.type) : S.getDefaultLegendMarker(p.type) : p.markerType,
          ...
          var x = p.dataPoints[y],
              q = x.legendMarkerType ? x.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : S.getDefaultLegendMarker(p.type),
      ...
      if (0 < m.length) {
        ...
        for (n = 0; n < m.length; n++) {
          ...
          if (!(0 >= l || "undefined" === typeof l || 0 >= v || "undefined" === typeof v)) {
            ...
            t = q.textBlock.width + (w + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0));
          }
        }
    ...
    A.prototype.createLabels = function () {
      ...
      if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
      ...
      } else for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Wa(new Date(this.viewportMaximum), this.interval, this.intervalType), g = q, c = this.intervalStartPosition; c < e; Wa(c, b, this.intervalType)) {
        ...
        a || (a = this.labelFormatter ? this.labelFormatter({
          ...
          value: new Date(n),
          label: this.labels[n] ? this.labels[n] : null
        }) : "axisX" === this.type && this.labels[n] ? this.labels[n] : Aa(n, this.valueFormatString, this.chart._cultureInfo), a = new ja(this.ctx, {
          x: 0,
          y: 0,
          maxWidth: f,
          backgroundColor: this.labelBackgroundColor,
      ...
      e = [];
      q = p = 0;
      if (this.labelAutoFit || this.options.labelAutoFit) if (r(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position) {
        if (f = 0.9 * h >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
            ...
            if (!this._labels[c].breaksLabelType) {
              ...
              if (r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle) {
                if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), n = (k - (m + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !r(this.options.labelWrap)) this.labelWrap ? r(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), n), this.sessionVariables.labelWrap = this.labelWrap, d && t.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle) : r(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelMaxWidth = f, d && t.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = n)) : (this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelWrap = this.labelWrap);else {
                  if (r(this.options.labelWrap)) if (!r(this.options.labelMaxWidth)) this.options.labelMaxWidth < f ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = l);else if (!r(d)) if (b = t.width + d.width >> 0, g = this.labelFontSize, q < f) b - 2 * f > p && (p = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, r(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 2.2 * f && b < 2.8 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = n, this.sessionVariables.labelFontSize = g) : b >= 2.8 * f && b < 3.2 * f ? (this.sessionVariables.labelMaxWidth = Math.max(f, q), this.sessionVariables.labelWrap = !0, r(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * f && b < 3.6 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = n, this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * f && b < 5 * f ? (r(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = n) : b > 5 * f && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelFontSize = g, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelAngle = this.labelAngle));else if (v === c && (0 === v && q + this._labels[v + 1].textBlock.measureText().width - 2 * f > p || v === this._labels.length - 1 && q + this._labels[v - 1].textBlock.measureText().width - 2 * f > p || 0 < v && v < this._labels.length - 1 && q + this._labels[v + 1].textBlock.measureText().width - 2 * f > p && q + this._labels[v - 1].textBlock.measureText().width - 2 * f > p)) p = 0 === v ? q + this._labels[v + 1].textBlock.measureText().width - 2 * f : q + this._labels[v - 1].textBlock.measureText().width - 2 * f, this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = n;else if (0 === p) for (this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0; b < this._labels.length; b++) {
          ...
          a = this._labels[c].textBlock, a.maxWidth = this.labelMaxWidth = r(this.options.labelMaxWidth) ? r(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth = f : this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth, a.fontSize = this.labelFontSize = r(this.options.labelFontSize) ? r(this.sessionVariables.labelFontSize) ? this.sessionVariables.labelFontSize = this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize, a.angle = this.labelAngle = r(this.options.labelAngle) ? r(this.sessionVariables.labelAngle) ? this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = r(this.options.labelWrap) ? r(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = r(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = l : this.sessionVariables.labelMaxHeight, a.measureText();
        }
        ...
        for (c = 0; c < this._labels.length; c++) {
          if (!this._labels[c].breaksLabelType) {
            ...
            Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
            Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
            r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle ? r(this.options.labelWrap) ? r(this.options.labelWrap) && (r(this.options.labelMaxWidth) ? r(d) || (h = t.height + d.height >> 0, h - 2 * l > q && (q = h - 2 * l, h >= 2 * l && h < 2.4 * l ? (r(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize) : h >= 2.4 * l && h < 2.8 * l ? (this.sessionVariables.labelMaxHeight = b, this.sessionVariables.labelFontSize = this.labelFontSize, this.sessionVariables.labelWrap = !0) : h >= 2.8 * l && h < 3.2 * l ? (this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelWrap = !0, r(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize, this.sessionVariables.labelAngle = r(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : h >= 3.2 * l && h < 3.6 * l ? (this.sessionVariables.labelMaxHeight = b, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelFontSize = this.labelFontSize) : h > 3.6 * l && h < 10 * l ? (r(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelAngle = r(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : h > 10 * l && h < 50 * l && (r(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelAngle = r(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))) : (this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth)) : (this.sessionVariables.labelMaxWidth = this.labelWrap ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : this.labelMaxWidth ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : f, this.sessionVariables.labelMaxHeight = l) : (this.sessionVariables.labelAngle = this.labelAngle, this.sessionVariables.labelMaxWidth = 0 === this.labelAngle ? f : Math.min((b - l * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), l), r(this.options.labelWrap)) ? r(this.options.labelWrap) && (this.labelWrap && !r(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth, this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : f, this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : b, r(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle))) : this.options.labelWrap ? (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : b, this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxWidth = f) : (this.sessionVariables.labelMaxHeight = l, r(this.options.labelMaxWidth), this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth, this.sessionVariables.labelWrap = this.labelWrap);
          }
        }
      ...
      for (c = 0; c < this.stripLines.length; c++) {
        ...
        } else l = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0, A = r(f.options.labelWrap) || f.labelWrap ? "bottom" === this._position || "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize, r(f.labelBackgroundColor) && (r(f.startValue) && 0 !== f.startValue ? f.labelBackgroundColor = w ? "transparent" : null : f.labelBackgroundColor = "#EEEEEE");
    ...
    A.setLayout = function (a, d, c, b, e, f) {
      ...
      for (g = 0; g < q.length; g++) {
        if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length) for (var t = q[g].scaleBreaks._appliedBreaks, w = 0; w < t.length && !(t[w].startValue > q[g].viewportMaximum); w++) {
          t[w].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w), t[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
        }
      }

      for (var v = w = 0, u = 0, y = 0, x = 0, z = 0, A = 0, C, B, E = h = 0, I, J, K, t = I = J = K = !1, g = 0; g < q.length; g++) {
      ...
      if ("normal" === e) {
        for (var y = [], x = [], z = [], A = [], N = [], O = [], P = [], R = []; 4 > w;) {
          var F = 0,
              ...
              Q = 0,
              $ = 0;
          if (c && 0 < c.length) for (z = [], g = Q = 0; g < c.length; g++) {
            z.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), Q += z[g], L += c[g] && !n.isNavigator ? c[g].margin : 0;
          } else z.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
          P.push(z);
          if (b && 0 < b.length) for (A = [], g = $ = 0; g < b.length; g++) {
            A.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), $ += A[g], Z += b[g] ? b[g].margin : 0;
          ...
          if (a && 0 < a.length) for (y = [], g = V = 0; g < a.length; g++) {
          ...
          N.push(y);
          if (d && 0 < d.length) for (x = [], g = X = 0; g < d.length; g++) {
          ...
          if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
            a[g] && (a[g].lineCoordinates.x1 = l, m = Math.round(f.x2 - $ - Z > n.width - p ? n.width - p : f.x2 - $ - Z), a[g]._labels && 1 < a[g]._labels.length && (h = k = 0, k = a[g]._labels[1], h = "dateTime" === a[g].valueType ? a[g]._labels[a[g]._labels.length - 2] : a[g]._labels[a[g]._labels.length - 1], v = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), u = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle))), !a[g] || !a[g].labelAutoFit || r(C) || r(B) || n.isNavigator || n.stockChart || (h = 0, 0 < a[g].labelAngle ? B + u > m && (h += 0 < a[g].labelAngle ? B + u - m - $ : 0) : 0 > a[g].labelAngle ? C - v < l && C - v < a[g].viewportMinimum && (E = l - (L + a[g].tickLength + z + C - v + a[g].labelFontSize / 2)) : 0 === a[g].labelAngle && (B + u > m && (h = B + u / 2 - m - $), C - v < l && C - v < a[g].viewportMinimum && (E = l - L - a[g].tickLength - z - C + v / 2)), a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < h ? m -= h : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < E ? l += E : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < E && (l += E), 0 < h && (m -= h))), n.panEnabled ? V = r(n.sessionVariables.axisX.height) ? n.sessionVariables.axisX.height = V : n.sessionVariables.axisX.height : n.sessionVariables.axisX.height = V, h = Math.round(f.y2 - V - e + F), k = Math.round(f.y2), a[g].lineCoordinates.x2 = m, a[g].lineCoordinates.width = m - l, a[g].lineCoordinates.y1 = h, a[g].lineCoordinates.y2 = h + a[g].lineThickness / 2, "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.y1 = a[g].lineCoordinates.y1 + y[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0) - ("inside" === a[g].tickPlacement ? a[g].tickLength : 0), a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), a[g].bounds = {
              x1: l,
              y1: h,
              x2: m,
              y2: k - (V + e - y[g] - F),
          ...
          if (c && 0 < c.length) for (g = 0; g < c.length; g++) {
            L = n.isNavigator ? 0 : 10, c[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p, h = Math.round(f.y1 + X + Y < Math.max(L, p) ? Math.max(L, p) : f.y1 + X + Y), m = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : p, k = Math.round(f.y2 - V - e - L), c[g].lineCoordinates = {
              x1: l - U,
              y1: h,
              x2: m - U,
              y2: k,
              height: Math.abs(k - h)
            }, "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (z[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0)) + ("outside" === c[g].tickPlacement ? c[g].tickLength : 0), c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2), c[g].bounds = {
              x1: l - (z[g] + U),
              y1: h,
              x2: m,
              y2: k,
              width: m - l,
              height: k - h
            }, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), U += z[g] + c[g].margin);
          }
          if (b && 0 < b.length) for (g = 0; g < b.length; g++) {
            b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), m = Math.round(l), L = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(f.y1 + X + Y < Math.max(L, p) ? Math.max(L, p) : f.y1 + X + Y), L = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (V + e + L)), b[g].lineCoordinates = {
              x1: l + W,
              y1: h,
              x2: l + W,
              y2: k,
              height: Math.abs(k - h)
            }, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (A[g] - (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2, b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2), b[g].bounds = {
              x1: l,
              y1: h,
              x2: m + (A[g] + W),
              y2: k,
              width: m - l,
              height: k - h
            }, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.height ? b[g].titleMaxWidth : b[g].lineCoordinates.height), W += A[g] + b[g].margin);
          }
          if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
        ...
        for (O = []; 4 > w;) {
          V = W = S = U = Z = L = Y = e = R = P = F = X = 0;
          if (a && 0 < a.length) for (E = [], g = W = 0; g < a.length; g++) {
            E.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), W += E[g], e += a[g] && !n.isNavigator ? a[g].margin : 0;
          } else E.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
          N.push(E);
          if (d && 0 < d.length) for (v = [], g = V = 0; g < d.length; g++) {
            v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), V += v[g], Y += d[g] ? d[g].margin : 0;
          } else v.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
          O.push(v);
          if (c && 0 < c.length) for (g = 0; g < c.length; g++) {
            c[g].lineCoordinates = {}, l = Math.round(f.x1 + W + e), m = Math.round(f.x2 - V - Y > n.width - 10 ? n.width - 10 : f.x2 - V - Y), c[g].labelAutoFit && !r(y) && (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, y) : 0 === c[g].labelAngle ? Math.max(l, y / 2) : l), 0 < !d.length && (m = 0 < c[g].labelAngle ? m - x / 2 : 0 === c[g].labelAngle ? m - x / 2 : m)), c[g].lineCoordinates.x1 = l, c[g].lineCoordinates.x2 = m, c[g].lineCoordinates.width = Math.abs(m - l), c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width);
          }
          if (b && 0 < b.length) for (g = 0; g < b.length; g++) {
            b[g].lineCoordinates = {}, l = Math.round(f.x1 + W + e), m = Math.round(f.x2 - V - Y > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - V - Y), b[g] && b[g].labelAutoFit && !r(z) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, z) : 0 === b[g].labelAngle ? Math.max(l, z / 2) : l), 0 < !d.length && (m -= A / 2)), b[g].lineCoordinates.x1 = l, b[g].lineCoordinates.x2 = m, b[g].lineCoordinates.width = Math.abs(m - l), b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width);
          }
          if (c && 0 < c.length) for (p = [], g = U = 0; g < c.length; g++) {
            p.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), U += p[g] + c[g].margin, L += c[g].margin;
          } else p.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
          B.push(p);
          if (b && 0 < b.length) for (C = [], g = S = 0; g < b.length; g++) {
            C.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), S += C[g], Z += b[g].margin;
          } else C.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
          u.push(C);
          if (c && 0 < c.length) for (g = 0; g < c.length; g++) {
            0 < c[g]._labels.length && (k = c[g]._labels[0], h = c[g]._labels[c[g]._labels.length - 1], y = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), x = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)));
          }
          if (b && 0 < b.length) for (g = 0; g < b.length; g++) {
            b[g] && 0 < b[g]._labels.length && (k = b[g]._labels[0], h = b[g]._labels[b[g]._labels.length - 1], z = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), A = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)));
          }
          if (n.panEnabled) for (g = 0; g < c.length; g++) {
            p[g] = r(n.sessionVariables.axisY.height) ? n.sessionVariables.axisY.height = p[g] : n.sessionVariables.axisY.height;
          } else for (g = 0; g < c.length; g++) {
            n.sessionVariables.axisY.height = p[g];
          }
          if (c && 0 < c.length) for (g = c.length - 1; 0 <= g; g--) {
            h = Math.round(f.y2), k = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2), c[g].lineCoordinates.y1 = h - (p[g] + c[g].margin + X), c[g].lineCoordinates.y2 = h - (p[g] + c[g].margin + X), "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + p[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ("inside" === c[g].tickPlacement ? c[g].tickLength : 0), c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), c[g].bounds = {
              x1: l,
          ...
          if (b && 0 < b.length) for (g = b.length - 1; 0 <= g; g--) {
            b[g] && (h = Math.round(f.y1), k = Math.round(f.y1 + (C[g] + b[g].margin + F)), b[g].lineCoordinates.y1 = k, b[g].lineCoordinates.y2 = k, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = k - C[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = {
              x1: l,
              y1: h + (b[g].margin + F),
              x2: m,
              y2: k,
              width: m - l,
              height: S
            }, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width), F += C[g] + b[g].margin);
          }
          if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
            ...
            if (c && 0 < c.length) for (L = 0; L < c.length; L++) {
              c[L] && c[L].labelAutoFit && (m = 0 > c[L].labelAngle ? Math.max(m, y) : 0 === c[L].labelAngle ? Math.max(m, y / 2) : m, l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? m - W : l);
            }
            if (b && 0 < b.length) for (L = 0; L < b.length; L++) {
              b[L] && b[L].labelAutoFit && (m = b[L].lineCoordinates.x1, l = m - W);
            }
            a[g].lineCoordinates = {
              x1: m - P,
              y1: h,
          ...
          if (d && 0 < d.length) for (g = 0; g < d.length; g++) {
            ...
            l = Math.round(f.x1 - e);
            h = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 < Math.max(L, 10) ? Math.max(L, 10) : f.y1) : f.y1 < Math.max(L, 10) ? Math.max(L, 10) : f.y1;
            m = Math.round(f.x2 - V - Y);
            k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > n.height - Math.max(L, 10) ? n.height - Math.max(L, 10) : f.y2 - U) : f.y2 > n.height - Math.max(L, 10) ? n.height - Math.max(L, 10) : f.y2;
            if (c && 0 < c.length) for (L = 0; L < c.length; L++) {
              c[L] && c[L].labelAutoFit && (m = 0 > c[L].labelAngle ? Math.max(m, y) : 0 === c[L].labelAngle ? Math.max(m, y / 2) : m, l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? m - V : l);
            }
            if (b && 0 < b.length) for (L = 0; L < b.length; L++) {
              b[L] && b[L].labelAutoFit && (m = b[L].lineCoordinates.x2, l = m - V);
            }
            d[g].lineCoordinates = {
              x1: m + R,
              y1: h,
    ...
    A.prototype.calculateBreaksSizeInValues = function () {
      for (var a = "left" === this._position || "right" === this._position ? this.lineCoordinates.height || this.chart.height : this.lineCoordinates.width || this.chart.width, d = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = this.conversionParameters.pixelPerUnit || a / (this.logarithmic ? this.conversionParameters.maximum / this.conversionParameters.minimum : this.conversionParameters.maximum - this.conversionParameters.minimum), b = this.scaleBreaks && !r(this.scaleBreaks.options.spacing), e, f = 0; f < d.length; f++) {
        e = b || !r(d[f].options.spacing), d[f].spacing = Sa(d[f].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0, d[f].size = 0 > d[f].spacing ? 0 : Math.abs(d[f].spacing / c), this.logarithmic && (d[f].size = Math.pow(this.logarithmBase, d[f].size));
      }
    };
    ...
    A.prototype.renderAxisLine = function () {
      ...
      if ("bottom" === this._position || "top" === this._position) {
        if (this.lineThickness) {
          ...
          d.strokeStyle = this.lineColor ? this.lineColor : "white";
          ...
          d.beginPath();
          if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex)) if (r(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;else for (var h = this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++) {
        ...
        d.beginPath();
        if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex)) if (r(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c;else for (h = this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++) {
    ...
    A.prototype.getApparentDifference = function (a, d, c, b) {
      ...
      } else for (c = r(c) ? Math.abs(d - a) : c, f = 0; f < e.length && !(d < e[f].startValue); f++) {
    ...
    A.prototype.calculateAxisParameters = function () {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();else {
        ...
        if (r(this.options.viewportMaximum) && !r(this.sessionVariables.newViewportMaximum) && !isNaN(this.sessionVariables.newViewportMaximum)) this.viewportMaximum = this.sessionVariables.newViewportMaximum;else if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = this.maximum;
    ...
    $.prototype.createUserOptions = function (a) {
    ...
    ca.prototype.showAt = function (a) {
      ...
      for (b = 0; b < d.axisX.length; b++) {
        a = d.axisX[b]._crosshairValue, d.axisX[b].crosshair && d.axisX[b].crosshair.enabled && !r(a) && a >= d.axisX[b].viewportMinimum && a <= d.axisX[b].viewportMaximum && (d.axisX[b].showCrosshair(a), d.axisX[b].crosshair._updatedValue = a, this === d.axisX[b].crosshair && (c = !0));
      }

      for (b = 0; b < d.axisX2.length; b++) {
        a = d.axisX2[b]._crosshairValue, d.axisX2[b].crosshair && d.axisX2[b].crosshair.enabled && !r(a) && a >= d.axisX2[b].viewportMinimum && a <= d.axisX2[b].viewportMaximum && (d.axisX2[b].showCrosshair(a), d.axisX2[b].crosshair._updatedValue = a, this === d.axisX2[b].crosshair && (c = !0));
      }

      for (b = 0; b < d.axisY.length; b++) {
        a = d.axisY[b]._crosshairValue, d.axisY[b].crosshair && d.axisY[b].crosshair.enabled && !r(a) && a >= d.axisY[b].viewportMinimum && a <= d.axisY[b].viewportMaximum && (d.axisY[b].showCrosshair(a), d.axisY[b].crosshair._updatedValue = a, this === d.axisY[b].crosshair && (c = !0));
      }

      for (b = 0; b < d.axisY2.length; b++) {
        a = d.axisY2[b]._crosshairValue, d.axisY2[b].crosshair && d.axisY2[b].crosshair.enabled && !r(a) && a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum && (d.axisY2[b].showCrosshair(a), d.axisY2[b].crosshair._updatedValue = a, this === d.axisY2[b].crosshair && (c = !0));
      }
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var B = 0; B < this.parent.dataSeries.length; B++) {
            (v = this.parent.dataSeries[B].getDataPointAtX(t, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[B], null !== v.dataPoint.y && v.dataSeries.visible && n.push(v));
          }
          ...
          B = 0;
          if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(n[B].dataPoint.y[0])), u = 0, t = 0; t < n.length; t++) {
            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (var y = 0; y < n[t].dataPoint.y.length; y++) {
              u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < v && (v = u, B = t);
            } else u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < v && (v = u, B = t);
          } else if ("stackedBar" === n[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), x = u = 0, t = B = 0; t < n.length; t++) {
            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) {
              u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < v && (v = u, B = t);
            } else x += n[t].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(x)), u < v && (v = u, B = t);
          } else if ("stackedBar100" === n[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), z = x = u = 0, t = 0; t < n.length; t++) {
            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) {
              u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < v && (v = u, B = t);
            } else x += n[t].dataPoint.y, z = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, z = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, B = t);
          } else for (v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = B = u = 0; t < n.length; t++) {
            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) {
              u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < v && (v = u, B = t);
            } else u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < v && (v = u, B = t);
          }
          ...
          if ("bottom" === this.parent._position || "top" === this.parent._position) {
            ...
            if ("rangeBar" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type) {
              ...
              for (t = u = 0; t < y.dataPoint.y.length; t++) {
                u = Math.abs(a - this.parent.convertValueToPixel(y.dataPoint.y[t])), u < v && (v = u, b = t);
              }
              ...
              }) : r(this.options.label) ? da(r(c) ? y.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo) : this.label;
            } else if ("stackedBar" === this.parent.dataSeries[B].type) {
              v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y));
              x = u = 0;

              for (t = B; 0 <= t; t--) {
                x += n[t].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(x)), u < v && (v = u, b = t);
              }
              ...
              k.text = this.labelFormatter ? this.labelFormatter({
                ...
                crosshair: this.options,
                value: y.dataPoint.y
              }) : r(this.options.label) ? da(r(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label;
            } else if ("stackedBar100" === this.parent.dataSeries[B].type) {
              v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y));
              z = x = u = 0;

              for (t = B; 0 <= t; t--) {
                x += n[t].dataPoint.y, z = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, z = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, b = t);
              }
            ...
            z = !1;
            if (this.parent.labels) for (n = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t += n) {
              if (this.parent.labels[t]) z = !0;else {
                z = !1;
                break;
              }
            }
            ...
            if (z) {
              if ("axisX" === this.parent.type) for (t = this.parent.convertPixelToValue({
                y: d
              }), v = null, B = 0; B < this.parent.dataSeries.length; B++) {
                (v = this.parent.dataSeries[B].getDataPointAtX(t, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({
                  chart: this.chart,
                  axis: this.parent.options,
                  crosshair: this.options,
                  value: y.dataPoint.x
              ...
              crosshair: this.options,
              value: y.dataPoint.x
            }) : r(this.options.label) ? Aa(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
              chart: this.chart,
              axis: this.parent.options,
              crosshair: this.options,
              value: y.dataPoint.x
            }) : r(this.options.label) ? da(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
          ...
          B = 0;
          if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" === n[0].dataSeries.type || "candlestick" === n[0].dataSeries.type || "ohlc" === n[0].dataSeries.type || "boxAndWhisker" === n[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), t = u = 0; t < n.length; t++) {
            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) {
              u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < v && (v = u, B = t);
            } else u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < v && (v = u, B = t);
          } else if ("stackedColumn" === n[0].dataSeries.type || "stackedArea" === n[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = x = u = 0; t < n.length; t++) {
            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) {
              u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < v && (v = u, B = t);
            } else x += n[t].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < v && (v = u, B = t);
          } else if ("stackedColumn100" === n[0].dataSeries.type || "stackedArea100" === n[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = z = x = u = 0; t < n.length; t++) {
            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) {
              u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < v && (v = u, B = t);
            } else x += n[t].dataPoint.y, z = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, z = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(d - this.parent.convertValueToPixel(z)), u < v && (v = u, B = t);
          } else for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = u = 0; t < n.length; t++) {
            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) {
              u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < v && (v = u, B = t);
            } else u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < v && (v = u, B = t);
          }
          ...
          if ("rangeColumn" === this.parent.dataSeries[B].type || "rangeArea" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type || "rangeSplineArea" === this.parent.dataSeries[B].type || "candlestick" === this.parent.dataSeries[B].type || "ohlc" === this.parent.dataSeries[B].type || "boxAndWhisker" === this.parent.dataSeries[B].type) {
            ...
            for (t = u = 0; t < y.dataPoint.y.length; t++) {
              u = Math.abs(d - this.parent.convertValueToPixel(y.dataPoint.y[t])), u < v && (v = u, b = t);
            }
            ...
            for (t = B; 0 <= t; t--) {
              x += n[t].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < v && (v = u, b = t);
            }
            ...
            for (t = B; 0 <= t; t--) {
              x += n[t].dataPoint.y, z = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, z = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(d - this.parent.convertValueToPixel(z)), u < v && (v = u, b = t);
            }
            ...
            this.value = z;
          } else "waterfall" === this.parent.dataSeries[B].type ? (w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum) << 0, k.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: y.dataSeries.dataPointEOs[y.index].cumulativeSum
          }) : r(this.options.label) ? da(r(c) ? y.dataSeries.dataPointEOs[y.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = y.dataSeries.dataPointEOs[y.index].cumulativeSum) : (w = 1 === q.lineWidth % 2 ? (r(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5 : r(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0, k.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: r(c) ? y.dataPoint.y : c
          }) : r(this.options.label) ? da(r(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = y.dataPoint.y);
        ...
        if ("left" === this.parent._position || "right" === this.parent._position) "left" === this.parent._position && k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1), "right" === this.parent._position && k.x + k.measureText().width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.measureText().width), h >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && (0 < p && (q.moveTo(b, f), q.lineTo(e, h), q.stroke(), this._hidden = !1), q.restore());
      } else {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          if ("left" === this.parent._position || "right" === this.parent._position) {
            ...
            }) : r(this.options.label) ? Aa(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
              chart: this.chart,
              axis: this.parent.options,
              crosshair: this.options,
              value: r(c) ? this.parent.convertPixelToValue(d) : c
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position) k.text = this.labelFormatter ? this.labelFormatter({
              ...
              crosshair: this.options,
              value: r(c) ? this.parent.convertPixelToValue(a) : c
            }) : r(this.options.label) ? da(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label, k.x = b - k.measureText().width / 2, k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width), k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1), "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2);
          }
        } else if ("bottom" === this.parent._position || "top" === this.parent._position) {
          z = !1;
          n = "";
          ...
          if (z) {
            ...
            crosshair: this.options,
            value: r(c) ? this.parent.convertPixelToValue(a) : c
          }) : r(this.options.label) ? Aa(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: r(c) ? 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "" : c
          }) : r(this.options.label) ? da(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label);
          ...
          crosshair: this.options,
          value: r(c) ? this.parent.convertPixelToValue(d) : c
        }) : r(this.options.label) ? da(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label, k.y = d + k.fontSize / 2 - k.measureText().height / 2 + 2, k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.measureText().height + k.fontSize / 2), "left" === this.parent._position ? k.x = this.parent.lineCoordinates.x2 - k.measureText().width : "right" === this.parent._position && (k.x = this.parent.lineCoordinates.x2);
        ...
        if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
          ...
          if (this.chart.axisX) for (var v = 0; v < this.chart.axisX.length; v++) {
            for (var h = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX[v].convertPixelToValue({
              ...
              x: a
            }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++) {
              (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && m.push(k));
            }
          ...
          if (this.chart.axisX2) for (v = 0; v < this.chart.axisX2.length; v++) {
            ...
            for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++) {
              (k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && m.push(k));
            }
          ...
          if (b = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = b.dataPointIndex, this.currentSeriesIndex = b.dataSeries.index;else if (w) {
          ...
          if (0 <= this.currentSeriesIndex) {
            ...
            if (!r(k) && !r(k.dataPoint) && !r(k.dataPoint.y)) if (k.dataSeries.axisY) {
        ...
        if (0 < f.length) {
          if (this.highlightObjects(f), this.enabled) {
            ...
            if (null !== c) {
              ...
              if (this.isToolTipDefinedInData && r(this.options.content) && r(this.options.contentFormatter)) for (h = this.contentDiv.getElementsByTagName("span"), b = 0; b < h.length; b++) {
      ...
      for (c = 0; c < a.length; c++) {
        ...
        if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
          var b = this.chart.data[e.dataSeriesIndex],
              ...
              h = e.dataPointIndex;
          !1 === f.highlightEnabled || !0 !== b.highlightEnabled && !0 !== f.highlightEnabled || ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "scatter" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type ? (f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size << 0, 10), f.borderColor = f.borderColor || "#2B2A2A", f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size), ba.drawMarkers([f]), "undefined" !== typeof e.y2 && (f = b.getMarkerProperties(h, e.x1, e.y2, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size << 0, 10), f.borderColor = f.borderColor || "#2B2A2A", f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size), ba.drawMarkers([f]))) : "bubble" === b.type ? (f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx), f.size = e.size, f.color = "white", f.borderColor = "white", d.globalAlpha = 0.3, ba.drawMarkers([f]), d.globalAlpha = 1) : "column" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "bar" === b.type || "rangeBar" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "rangeColumn" === b.type || "waterfall" === b.type ? ea(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? ia(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? qa(d, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, Math.min(e.y2, e.y3)), d.lineTo(e.x3 - b, Math.min(e.y1, e.y4)), d.stroke(), d.beginPath(), d.moveTo(e.x3 - b, Math.max(e.y1, e.y4)), d.lineTo(e.x3 - b, Math.max(e.y2, e.y3)), d.stroke(), ea(d, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1), d.globalAlpha = 1) : "ohlc" === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, e.y2), d.lineTo(e.x3 - b, e.y3), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y1), d.lineTo(e.x1, e.y1), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4), d.lineTo(e.x2, e.y4), d.stroke(), d.globalAlpha = 1) : "boxAndWhisker" === b.type ? (d.save(), d.globalAlpha = 1, d.strokeStyle = e.stemColor, d.lineWidth = 2 * e.stemThickness, 0 < e.stemThickness && (d.beginPath(), d.moveTo(e.x3, e.y2 + e.borderThickness / 2), d.lineTo(e.x3, e.y1 + e.whiskerThickness / 2), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4 - e.whiskerThickness / 2), d.lineTo(e.x3, e.y3 - e.borderThickness / 2), d.stroke()), d.beginPath(), ea(d, e.x1 - e.borderThickness / 2, Math.max(e.y2 + e.borderThickness / 2, e.y3 + e.borderThickness / 2), e.x2 + e.borderThickness / 2, Math.min(e.y2 - e.borderThickness / 2, e.y3 - e.borderThickness / 2), "transparent", e.borderThickness, e.color, !1, !1, !1, !1), d.globalAlpha = 1, d.strokeStyle = e.whiskerColor, d.lineWidth = 2 * e.whiskerThickness, 0 < e.whiskerThickness && (d.beginPath(), d.moveTo(Math.floor(e.x3 - e.whiskerLength / 2), e.y4), d.lineTo(Math.ceil(e.x3 + e.whiskerLength / 2), e.y4), d.stroke(), d.beginPath(), d.moveTo(Math.floor(e.x3 - e.whiskerLength / 2), e.y1), d.lineTo(Math.ceil(e.x3 + e.whiskerLength / 2), e.y1), d.stroke()), d.globalAlpha = 1, d.strokeStyle = e.lineColor, d.lineWidth = 2 * e.lineThickness, 0 < e.lineThickness && (d.beginPath(), d.moveTo(e.x1, e.y5), d.lineTo(e.x2, e.y5), d.stroke()), d.restore(), d.globalAlpha = 1) : "error" === b.type && E(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3));
        }
      }
    ...
    Z.prototype.showAtX = function (a, d) {
      ...
      if (this.shared) for (var h = 0; h < this.chart.data.length; h++) {
        c = this.chart.data[h], (b = c.getDataPointAtX(a, !1)) && b.dataPoint && !r(b.dataPoint.y) && c.visible && (b.dataSeries = c, f.push(b));
      ...
      if (0 < f.length) {
        ...
        if (null !== h) {
          ...
          if (this.isToolTipDefinedInData && r(this.options.content) && r(this.options.contentFormatter)) for (b = this.contentDiv.getElementsByTagName("span"), h = 0; h < b.length; h++) {
    ...
    Y.prototype.cancelAllAnimations = function () {
      this.animations = [];
    ...
    var N = {
      ...
      drawMarker: function drawMarker(a, d, c, b, e, f, h, m) {
        if (c) {
          var r = 1;
          c.fillStyle = f ? f : "#2B2A2A";
          c.strokeStyle = h ? h : "#2B2A2A";
          c.lineWidth = m ? m : 0;
          c.setLineDash && c.setLineDash(J("solid", m));
          "circle" === b ? (c.moveTo(a, d), c.beginPath(), c.arc(a, d, e / 2, 0, 2 * Math.PI, !1), f && c.fill(), m && (h ? c.stroke() : (r = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "white", c.stroke(), c.globalAlpha = r))) : "square" === b ? (c.beginPath(), c.rect(a - e / 2, d - e / 2, e, e), f && c.fill(), m && (h ? c.stroke() : (r = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "white", c.stroke(), c.globalAlpha = r))) : "triangle" === b ? (c.beginPath(), c.moveTo(a - e / 2, d + e / 2), c.lineTo(a + e / 2, d + e / 2), c.lineTo(a, d - e / 2), c.closePath(), f && c.fill(), m && (h ? c.stroke() : (r = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "white", c.stroke(), c.globalAlpha = r)), c.beginPath()) : "cross" === b && (c.strokeStyle = f, c.lineWidth = e / 4, c.beginPath(), c.moveTo(a - e / 2, d - e / 2), c.lineTo(a + e / 2, d + e / 2), c.stroke(), c.moveTo(a + e / 2, d - e / 2), c.lineTo(a - e / 2, d + e / 2), c.stroke());
        }
      },
